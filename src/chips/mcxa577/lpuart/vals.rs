...
impl Bsel32k {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Bsel32k {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Bsel32k {
    #[inline(always)]
    fn from(val: u8) -> Bsel32k {
        Bsel32k::from_bits(val)
    }
}
impl From<Bsel32k> for u8 {
    #[inline(always)]
    fn from(val: Bsel32k) -> u8 {
        Bsel32k::to_bits(val)
    }
}
#[repr(u8)]
...
impl Msel32k {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Msel32k {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Msel32k {
    #[inline(always)]
    fn from(val: u8) -> Msel32k {
        Msel32k::from_bits(val)
    }
}
impl From<Msel32k> for u8 {
    #[inline(always)]
    fn from(val: Msel32k) -> u8 {
        Msel32k::to_bits(val)
    }
}
#[repr(u8)]
...
impl Stpfix {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Stpfix {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Stpfix {
    #[inline(always)]
    fn from(val: u8) -> Stpfix {
        Stpfix::from_bits(val)
    }
}
impl From<Stpfix> for u8 {
    #[inline(always)]
    fn from(val: Stpfix) -> u8 {
        Stpfix::to_bits(val)
    }
}
#[repr(u8)]
