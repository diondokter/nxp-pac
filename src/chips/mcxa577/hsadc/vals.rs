...
pub enum Cmdh1Loop {
    ...
    #[doc = "Loop corresponding number of times. Command executes LOOP+1 times."]
    CMD_EXECUTES_CORRESPONDING_TIMES_10 = 0x0a,
    #[doc = "Loop corresponding number of times. Command executes LOOP+1 times."]
    CMD_EXECUTES_CORRESPONDING_TIMES_11 = 0x0b,
    #[doc = "Loop corresponding number of times. Command executes LOOP+1 times."]
    CMD_EXECUTES_CORRESPONDING_TIMES_12 = 0x0c,
    #[doc = "Loop corresponding number of times. Command executes LOOP+1 times."]
    CMD_EXECUTES_CORRESPONDING_TIMES_13 = 0x0d,
    #[doc = "Loop corresponding number of times. Command executes LOOP+1 times."]
    CMD_EXECUTES_CORRESPONDING_TIMES_14 = 0x0e,
...
pub enum Cmdl1Adch {
    ...
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_10 = 0x0a,
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_11 = 0x0b,
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_12 = 0x0c,
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_13 = 0x0d,
    _RESERVED_e = 0x0e,
    _RESERVED_f = 0x0f,
    _RESERVED_10 = 0x10,
    _RESERVED_11 = 0x11,
    ...
    _RESERVED_17 = 0x17,
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_24 = 0x18,
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_25 = 0x19,
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_26 = 0x1a,
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_27 = 0x1b,
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_28 = 0x1c,
    #[doc = "Select corresponding channel CHnA."]
    SELECT_CORRESPONDING_CHANNEL_29 = 0x1d,
    #[doc = "Select CH30A."]
    SELECT_CH30 = 0x1e,
    #[doc = "Select CH31A."]
    SELECT_CH31 = 0x1f,
...
pub enum Loopcnt {
    ...
    #[doc = "Result is from LOOPCNT+1 conversion in command."]
    CORRESPONDING_RESULT_10 = 0x0a,
    #[doc = "Result is from LOOPCNT+1 conversion in command."]
    CORRESPONDING_RESULT_11 = 0x0b,
    #[doc = "Result is from LOOPCNT+1 conversion in command."]
    CORRESPONDING_RESULT_12 = 0x0c,
    #[doc = "Result is from LOOPCNT+1 conversion in command."]
    CORRESPONDING_RESULT_13 = 0x0d,
    #[doc = "Result is from LOOPCNT+1 conversion in command."]
    CORRESPONDING_RESULT_14 = 0x0e,
...
pub enum TcompFlag {
    ...
    #[doc = "Associated trigger sequence has completed and has enabled completion interrupts."]
    SET_BITS_INDICATE_TRIGGER_X_COMPLETED_10 = 0x0a,
    #[doc = "Associated trigger sequence has completed and has enabled completion interrupts."]
    SET_BITS_INDICATE_TRIGGER_X_COMPLETED_11 = 0x0b,
    #[doc = "Associated trigger sequence has completed and has enabled completion interrupts."]
    SET_BITS_INDICATE_TRIGGER_X_COMPLETED_12 = 0x0c,
    #[doc = "Associated trigger sequence has completed and has enabled completion interrupts."]
    SET_BITS_INDICATE_TRIGGER_X_COMPLETED_13 = 0x0d,
    #[doc = "Associated trigger sequence has completed and has enabled completion interrupts."]
    SET_BITS_INDICATE_TRIGGER_X_COMPLETED_14 = 0x0e,
...
pub enum TcompIe {
    ...
    #[doc = "Associated trigger completion interrupts are enabled."]
    TRIGGER_X_COMPLETE_ENABLED_10 = 0x0a,
    #[doc = "Associated trigger completion interrupts are enabled."]
    TRIGGER_X_COMPLETE_ENABLED_11 = 0x0b,
    #[doc = "Associated trigger completion interrupts are enabled."]
    TRIGGER_X_COMPLETE_ENABLED_12 = 0x0c,
    #[doc = "Associated trigger completion interrupts are enabled."]
    TRIGGER_X_COMPLETE_ENABLED_13 = 0x0d,
    #[doc = "Associated trigger completion interrupts are enabled."]
    TRIGGER_X_COMPLETE_ENABLED_14 = 0x0e,
...
pub enum TexcNum {
    ...
    #[doc = "Associated trigger sequence has interrupted by a high priority exception."]
    SET_BITS_INDICATE_TRIGGER_X_INTERRUPTED_10 = 0x0a,
    #[doc = "Associated trigger sequence has interrupted by a high priority exception."]
    SET_BITS_INDICATE_TRIGGER_X_INTERRUPTED_11 = 0x0b,
    #[doc = "Associated trigger sequence has interrupted by a high priority exception."]
    SET_BITS_INDICATE_TRIGGER_X_INTERRUPTED_12 = 0x0c,
    #[doc = "Associated trigger sequence has interrupted by a high priority exception."]
    SET_BITS_INDICATE_TRIGGER_X_INTERRUPTED_13 = 0x0d,
    #[doc = "Associated trigger sequence has interrupted by a high priority exception."]
    SET_BITS_INDICATE_TRIGGER_X_INTERRUPTED_14 = 0x0e,
