...
pub enum Btml {
    #[doc = "Single lane"]
    SINGLE = 0x0,
    #[doc = "Single or dual lanes"]
    SINGLE_DUAL = 0x01,
    _RESERVED_2 = 0x02,
    #[doc = "Single, dual, or quad lanes"]
    SINGLE_DUAL_QUAD = 0x03,
}
impl Btml {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Btml {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Btml {
    #[inline(always)]
    fn from(val: u8) -> Btml {
        Btml::from_bits(val)
    }
}
impl From<Btml> for u8 {
    #[inline(always)]
    fn from(val: Btml) -> u8 {
        Btml::to_bits(val)
    }
...
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum Smlane {
    #[doc = "Single lane only"]
    SINGLE_LANE = 0x0,
    #[doc = "Dual lane capable (single and dual)"]
    DUAL_LANE = 0x01,
    _RESERVED_2 = 0x02,
    #[doc = "Quad lane capable (single, dual, quad)"]
    QUAD_LANE = 0x03,
}
impl Smlane {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Smlane {
        unsafe { core::mem::transmute(val & 0x03) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Smlane {
    #[inline(always)]
    fn from(val: u8) -> Smlane {
        Smlane::from_bits(val)
    }
}
impl From<Smlane> for u8 {
    #[inline(always)]
    fn from(val: Smlane) -> u8 {
        Smlane::to_bits(val)
    }
}
#[repr(u8)]
