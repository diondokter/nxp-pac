...
impl Merrwarn {
    ...
    #[doc = "HDR-BT Not Verified Flag"]
    #[must_use]
    #[inline(always)]
    pub const fn hnoverify(&self) -> bool {
        let val = (self.0 >> 12usize) & 0x01;
        val != 0
    }
    #[doc = "HDR-BT Not Verified Flag"]
    #[inline(always)]
    pub const fn set_hnoverify(&mut self, val: bool) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn wrongsize(&self) -> bool {
        let val = (self.0 >> 21usize) & 0x01;
        val != 0
    }
    #[doc = "Wrong Size Flag"]
    #[inline(always)]
    pub const fn set_wrongsize(&mut self, val: bool) {
...
impl defmt::Format for Merrwarn {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Merrwarn {{ urun: {=bool:?}, nack: {=bool:?}, wrabt: {=bool:?}, term: {=bool:?}, hpar: {=bool:?}, hcrc: {=bool:?}, hnoverify: {=bool:?}, oread: {=bool:?}, owrite: {=bool:?}, msgerr: {=bool:?}, invreq: {=bool:?}, timeout: {=bool:?}, wrongsize: {=bool:?} }}",
            self.urun(),
            self.nack(),
            self.wrabt(),
            self.term(),
...
impl Mhdrbtcfg {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn mlhdr(&self) -> super::vals::Mlhdr {
        let val = (self.0 >> 0usize) & 0x03;
        super::vals::Mlhdr::from_bits(val as u8)
    }
    #[doc = "Multi-Lane HDR"]
    #[inline(always)]
    pub const fn set_mlhdr(&mut self, val: super::vals::Mlhdr) {
        self.0 = (self.0 & !(0x03 << 0usize)) | (((val.to_bits() as u32) & 0x03) << 0usize);
    }
    #[doc = "Multi-Lane Data"]
    #[must_use]
    #[inline(always)]
    pub const fn mldat(&self) -> super::vals::Mldat {
        let val = (self.0 >> 2usize) & 0x03;
        super::vals::Mldat::from_bits(val as u8)
    }
    #[doc = "Multi-Lane Data"]
    #[inline(always)]
    pub const fn set_mldat(&mut self, val: super::vals::Mldat) {
        self.0 = (self.0 & !(0x03 << 2usize)) | (((val.to_bits() as u32) & 0x03) << 2usize);
    }
    #[doc = "CRC32"]
    #[must_use]
...
impl defmt::Format for Scapabilities {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Scapabilities {{ idena: {:?}, idreg: {:?}, hdrsupp: {=u8:?}, master: {:?}, saddr: {:?}, ccchandle: {:?}, ibi_mr_hj: {:?}, timectrl: {:?}, extfifo: {:?}, fifotx: {:?}, fiforx: {:?}, int: {:?}, dma: {:?} }}",
            self.idena(),
            self.idreg(),
            self.hdrsupp(),
            self.master(),
...
impl Scapabilities2 {
    ...
    #[doc = "Select Multi-Lane"]
    #[must_use]
    #[inline(always)]
    pub const fn smlane(&self) -> super::vals::Smlane {
        let val = (self.0 >> 12usize) & 0x03;
        super::vals::Smlane::from_bits(val as u8)
    }
    #[doc = "Select Multi-Lane"]
    #[inline(always)]
    pub const fn set_smlane(&mut self, val: super::vals::Smlane) {
...
impl core::fmt::Debug for Scapabilities2 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Scapabilities2")
            ...
            .field("smlane", &self.smlane())
            .field("v1_1", &self.v1_1())
...
impl defmt::Format for Scapabilities2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Scapabilities2 {{ mapcnt: {=u8:?}, i2c10b: {=bool:?}, i2cdevid: {=bool:?}, data32: {=bool:?}, ibiext: {=bool:?}, ibixreg: {=bool:?}, smlane: {:?}, v1_1: {=bool:?}, slvrst: {=bool:?}, group: {:?}, aasa: {=bool:?}, sstsub: {=bool:?}, sstwr: {=bool:?} }}",
            self.mapcnt(),
            self.i2c10b(),
            self.i2cdevid(),
            self.data32(),
...
impl Sconfig {
    ...
    #[doc = "Bulk Transport Multi-Lane"]
    #[must_use]
    #[inline(always)]
    pub const fn btml(&self) -> super::vals::Btml {
        let val = (self.0 >> 5usize) & 0x03;
        super::vals::Btml::from_bits(val as u8)
    }
    #[doc = "Bulk Transport Multi-Lane"]
    #[inline(always)]
    pub const fn set_btml(&mut self, val: super::vals::Btml) {
...
impl defmt::Format for Sconfig {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Sconfig {{ slvena: {=bool:?}, nack: {=bool:?}, matchss: {=bool:?}, s0ignore: {=bool:?}, ddrok: {=bool:?}, btml: {:?}, offline: {=bool:?}, bamatch: {=u8:?}, saddr: {=u8:?} }}",
            self.slvena(),
            self.nack(),
            self.matchss(),
            self.s0ignore(),
...
impl defmt::Format for Serrwarn {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Serrwarn {{ orun: {=bool:?}, urun: {=bool:?}, urunnack: {=bool:?}, term: {=bool:?}, invstart: {=bool:?}, spar: {=bool:?}, hpar: {=bool:?}, hcrc: {=bool:?}, s0s1: {=bool:?}, hnoverify: {=bool:?}, oread: {=bool:?}, owrite: {=bool:?}, wrongsize: {=bool:?} }}",
            self.orun(),
            self.urun(),
            self.urunnack(),
            self.term(),
...
impl Shdrbtcfg {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn crc32(&self) -> super::vals::ShdrbtcfgCrc32 {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::ShdrbtcfgCrc32::from_bits(val as u8)
    }
    #[doc = "CRC32 Select"]
    #[inline(always)]
    pub const fn set_crc32(&mut self, val: super::vals::ShdrbtcfgCrc32) {
