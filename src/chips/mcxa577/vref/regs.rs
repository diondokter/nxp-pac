...
impl Csr {
    ...
    #[doc = "Current Mirror Block Enable"]
    #[must_use]
    #[inline(always)]
    pub const fn ibias_en(&self) -> super::vals::IbiasEn {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::IbiasEn::from_bits(val as u8)
    }
    #[doc = "Current Mirror Block Enable"]
    #[inline(always)]
    pub const fn set_ibias_en(&mut self, val: super::vals::IbiasEn) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Chop function Enable"]
    #[must_use]
    #[inline(always)]
    ...
    #[must_use]
    #[inline(always)]
    pub const fn refchseln_en(&self) -> super::vals::RefchselnEn {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::RefchselnEn::from_bits(val as u8)
    }
    #[doc = "Reference Channel Select Negative Enable"]
    #[inline(always)]
    pub const fn set_refchseln_en(&mut self, val: super::vals::RefchselnEn) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
    #[doc = "Reference Channel Select Positive Enable"]
    #[must_use]
    #[inline(always)]
    pub const fn refchselp_en(&self) -> super::vals::RefchselpEn {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::RefchselpEn::from_bits(val as u8)
    }
    #[doc = "Reference Channel Select Positive Enable"]
    #[inline(always)]
    pub const fn set_refchselp_en(&mut self, val: super::vals::RefchselpEn) {
...
impl core::fmt::Debug for Csr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Csr")
            ...
            .field("ibias_en", &self.ibias_en())
            .field("chopen", &self.chopen())
            .field("icompen", &self.icompen())
            .field("regen", &self.regen())
            .field("refchseln_en", &self.refchseln_en())
            .field("refchselp_en", &self.refchselp_en())
...
impl defmt::Format for Csr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Csr {{ hcbgen: {:?}, ibias_en: {:?}, chopen: {:?}, icompen: {:?}, regen: {:?}, refchseln_en: {:?}, refchselp_en: {:?}, hi_pwr_lv: {:?}, buf21en: {:?}, vrefst: {:?} }}",
            self.hcbgen(),
            self.ibias_en(),
            self.chopen(),
            self.icompen(),
