...
impl Pcr0 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr0Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr0Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr0Pv) {
...
impl defmt::Format for Pcr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr0 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
...
impl Pcr1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr1Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr1Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr1Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Passive Filter Enable"]
    #[must_use]
...
impl defmt::Format for Pcr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr1 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
...
impl Pcr2 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr2Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr2Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr2Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Passive Filter Enable"]
    #[must_use]
    #[inline(always)]
    pub const fn pfe(&self) -> super::vals::Pcr2Pfe {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Pcr2Pfe::from_bits(val as u8)
    }
    #[doc = "Passive Filter Enable"]
    #[inline(always)]
    pub const fn set_pfe(&mut self, val: super::vals::Pcr2Pfe) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Open Drain Enable"]
    #[must_use]
...
impl defmt::Format for Pcr2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr2 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
...
impl Pcr3 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr3Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr3Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr3Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Passive Filter Enable"]
    #[must_use]
    #[inline(always)]
    pub const fn pfe(&self) -> super::vals::Pcr3Pfe {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Pcr3Pfe::from_bits(val as u8)
    }
    #[doc = "Passive Filter Enable"]
    #[inline(always)]
    pub const fn set_pfe(&mut self, val: super::vals::Pcr3Pfe) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Open Drain Enable"]
    #[must_use]
...
impl defmt::Format for Pcr3 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr3 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
...
impl Pcr4 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr4Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr4Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr4Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Passive Filter Enable"]
    #[must_use]
...
impl defmt::Format for Pcr4 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr4 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
...
impl Pcr5 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr5Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr5Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr5Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Passive Filter Enable"]
    #[must_use]
...
impl defmt::Format for Pcr5 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr5 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
...
impl Pcr6 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr6Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr6Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr6Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Passive Filter Enable"]
    #[must_use]
    #[inline(always)]
    pub const fn pfe(&self) -> super::vals::Pcr6Pfe {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Pcr6Pfe::from_bits(val as u8)
    }
    #[doc = "Passive Filter Enable"]
    #[inline(always)]
    pub const fn set_pfe(&mut self, val: super::vals::Pcr6Pfe) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Open Drain Enable"]
    #[must_use]
...
impl defmt::Format for Pcr6 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr6 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
...
impl Pcr7 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr7Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr7Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr7Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Passive Filter Enable"]
    #[must_use]
    #[inline(always)]
    pub const fn pfe(&self) -> super::vals::Pcr7Pfe {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Pcr7Pfe::from_bits(val as u8)
    }
    #[doc = "Passive Filter Enable"]
    #[inline(always)]
    pub const fn set_pfe(&mut self, val: super::vals::Pcr7Pfe) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Open Drain Enable"]
    #[must_use]
...
impl defmt::Format for Pcr7 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr7 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
...
impl defmt::Format for Pcr8 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr8 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
...
impl Pcr9 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr9Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr9Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr9Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Passive Filter Enable"]
    #[must_use]
...
impl defmt::Format for Pcr9 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr9 {{ ps: {:?}, pe: {:?}, pv: {:?}, pfe: {:?}, ode: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.pfe(),
