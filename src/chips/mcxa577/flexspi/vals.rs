...
impl ArefAllZeroErr {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> ArefAllZeroErr {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl ArefOneHotErr {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> ArefOneHotErr {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl BrefAllZeroErr {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> BrefAllZeroErr {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl BrefOneHotErr {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> BrefOneHotErr {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for BrefOneHotErr {
    #[inline(always)]
    fn from(val: u8) -> BrefOneHotErr {
        BrefOneHotErr::from_bits(val)
    }
}
impl From<BrefOneHotErr> for u8 {
    #[inline(always)]
    fn from(val: BrefOneHotErr) -> u8 {
        BrefOneHotErr::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
