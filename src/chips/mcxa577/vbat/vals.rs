...
impl Sec0Det {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Sec0Det {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Sec0Det {
    #[inline(always)]
    fn from(val: u8) -> Sec0Det {
        Sec0Det::from_bits(val)
    }
}
impl From<Sec0Det> for u8 {
    #[inline(always)]
    fn from(val: Sec0Det) -> u8 {
        Sec0Det::to_bits(val)
    }
}
#[repr(u8)]
