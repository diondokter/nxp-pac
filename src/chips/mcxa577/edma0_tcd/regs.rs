...
impl ChSbr {
    ...
    #[doc = "Enable Initiator ID Replication"]
    #[must_use]
    #[inline(always)]
...
impl TcdAttr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dsize(&self) -> super::super::edma_0_tcd::vals::Size {
        let val = (self.0 >> 0usize) & 0x07;
        super::super::edma_0_tcd::vals::Size::from_bits(val as u8)
    }
    #[doc = "Destination Data Transfer Size"]
    #[inline(always)]
    pub const fn set_dsize(&mut self, val: super::super::edma_0_tcd::vals::Size) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ssize(&self) -> super::super::edma_0_tcd::vals::Size {
        let val = (self.0 >> 8usize) & 0x07;
        super::super::edma_0_tcd::vals::Size::from_bits(val as u8)
    }
    #[doc = "Source Data Transfer Size"]
    #[inline(always)]
    pub const fn set_ssize(&mut self, val: super::super::edma_0_tcd::vals::Size) {
