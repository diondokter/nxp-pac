...
pub enum AlmMatch {
    #[doc = "If CTRL\\[ALM_SUBSECS_MATCH_EN\\] =0, Only seconds, minutes, and hours matched. If CTRL\\[ALM_SUBSECS_MATCH_EN\\] =1, Only subseconds, seconds, minutes, and hours matched."]
    HOURS = 0x0,
    #[doc = "If CTRL\\[ALM_SUBSECS_MATCH_EN\\] =0, Only seconds, minutes, hours, and days matched. If CTRL\\[ALM_SUBSECS_MATCH_EN\\] =1, Only subseconds, seconds, minutes, hours, and days matched."]
    DAYS = 0x01,
    #[doc = "If CTRL\\[ALM_SUBSECS_MATCH_EN\\] =0, Only seconds, minutes, hours, days and months matched. If CTRL\\[ALM_SUBSECS_MATCH_EN\\] =1, Only subseconds, seconds, minutes, hours, days and months matched."]
    MONTHS = 0x02,
    #[doc = "If CTRL\\[ALM_SUBSECS_MATCH_EN\\] =0, Only seconds, minutes, hours, days, months and year (offset) matched. If CTRL\\[ALM_SUBSECS_MATCH_EN\\] =1, Only subseconds, seconds, minutes, hours, days, months and year (offset) matched."]
    YEAR = 0x03,
}
impl AlmMatch {
    #[inline(always)]
