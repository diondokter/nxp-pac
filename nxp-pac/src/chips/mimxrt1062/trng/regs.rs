...
impl defmt::Format for Mctl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Mctl {{ samp_mode: {:?}, osc_div: {:?}, unused4: {=bool:?}, unused5: {=bool:?}, rst_def: {=bool:?}, for_sclk: {=bool:?}, fct_fail: {=bool:?}, fct_val: {=bool:?}, ent_val: {=bool:?}, tst_out: {=bool:?}, err: {=bool:?}, tstop_ok: {=bool:?}, lrun_cont: {=bool:?}, prgm: {=bool:?} }}",
            self.samp_mode(),
            self.osc_div(),
            self.unused4(),
            self.unused5(),
...
impl defmt::Format for SecCfg {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SecCfg {{ unused0: {=bool:?}, no_prgm: {:?}, unused2: {=bool:?} }}",
            self.unused0(),
            self.no_prgm(),
            self.unused2()
        )
