...
impl defmt::Format for Scr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Scr {{ mask_wdog_rst: {:?}, core0_rst: {:?}, core0_dbg_rst: {:?}, dbg_rst_msk_pg: {:?}, mask_wdog3_rst: {:?} }}",
            self.mask_wdog_rst(),
            self.core0_rst(),
            self.core0_dbg_rst(),
            self.dbg_rst_msk_pg(),
...
impl defmt::Format for Srsr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Srsr {{ ipp_reset_b: {:?}, lockup_sysresetreq: {:?}, csu_reset_b: {:?}, ipp_user_reset_b: {:?}, wdog_rst_b: {:?}, jtag_rst_b: {:?}, jtag_sw_rst: {:?}, wdog3_rst_b: {:?}, tempsense_rst_b: {:?} }}",
            self.ipp_reset_b(),
