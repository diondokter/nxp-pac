...
impl Default for Rdr0 {
    #[inline(always)]
    fn default() -> Rdr0 {
        Rdr0(0)
    }
}
impl core::fmt::Debug for Rdr0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Rdr0").field("rdr", &self.rdr()).finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Rdr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Rdr0 {{ rdr: {=u32:?} }}", self.rdr())
    }
}
#[doc = "Receive FIFO."]
#[repr(transparent)]
...
impl Default for Tdr0 {
    #[inline(always)]
    fn default() -> Tdr0 {
        Tdr0(0)
    }
}
impl core::fmt::Debug for Tdr0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Tdr0").field("tdr", &self.tdr()).finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Tdr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Tdr0 {{ tdr: {=u32:?} }}", self.tdr())
    }
}
#[doc = "Transmit FIFO."]
#[repr(transparent)]
