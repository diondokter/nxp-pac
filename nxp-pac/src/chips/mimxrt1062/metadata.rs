...
pub const INTERRUPTS: &[(&str, u32)] = &[
    ...
    ("PXP", 44u32),
    ("WDOG2", 45u32),
    ("SNVS_HP_WRAPPER", 46u32),
    ("SNVS_HP_WRAPPER_TZ", 47u32),
    ("SNVS_LP_WRAPPER", 48u32),
    ("CSU", 49u32),
    ("DCP", 50u32),
    ("DCP_VMI", 51u32),
    ("RESERVED68", 52u32),
    ...
    ("GPIO1_INT6", 78u32),
    ("GPIO1_INT7", 79u32),
    ("GPIO1_COMBINED_0_15", 80u32),
    ("GPIO1_COMBINED_16_31", 81u32),
    ("GPIO2_COMBINED_0_15", 82u32),
    ("GPIO2_COMBINED_16_31", 83u32),
    ("GPIO3_COMBINED_0_15", 84u32),
    ("GPIO3_COMBINED_16_31", 85u32),
    ("GPIO4_COMBINED_0_15", 86u32),
    ("GPIO4_COMBINED_16_31", 87u32),
    ("GPIO5_COMBINED_0_15", 88u32),
    ("GPIO5_COMBINED_16_31", 89u32),
    ("FLEXIO1", 90u32),
    ("FLEXIO2", 91u32),
    ("WDOG1", 92u32),
    ("RTWDOG", 93u32),
    ...
    ("USB_OTG1", 113u32),
    ("ENET", 114u32),
    ("ENET_1588_TIMER", 115u32),
    ("XBAR1_IRQ_0_1", 116u32),
    ("XBAR1_IRQ_2_3", 117u32),
    ("ADC_ETC_IRQ0", 118u32),
    ("ADC_ETC_IRQ1", 119u32),
    ("ADC_ETC_IRQ2", 120u32),
    ("ADC_ETC_ERROR_IRQ", 121u32),
    ("PIT", 122u32),
    ("ACMP1", 123u32),
    ("ACMP2", 124u32),
    ("ACMP3", 125u32),
