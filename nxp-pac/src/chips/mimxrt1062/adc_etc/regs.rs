...
impl defmt::Format for Ctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ctrl {{ trig_enable: {:?}, ext0_trig_enable: {:?}, ext0_trig_priority: {=u8:?}, ext1_trig_enable: {:?}, ext1_trig_priority: {=u8:?}, pre_divider: {=u8:?}, dma_mode_sel: {:?}, tsc_bypass: {:?}, softrst: {:?} }}",
            self.trig_enable(),
...
impl defmt::Format for Done23ErrIrq {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Done23ErrIrq {{ trig0_done2: {:?}, trig1_done2: {:?}, trig2_done2: {:?}, trig3_done2: {:?}, trig4_done2: {:?}, trig5_done2: {:?}, trig6_done2: {:?}, trig7_done2: {:?}, trig0_err: {:?}, trig1_err: {:?}, trig2_err: {:?}, trig3_err: {:?}, trig4_err: {:?}, trig5_err: {:?}, trig6_err: {:?}, trig7_err: {:?} }}",
            self.trig0_done2(),
            self.trig1_done2(),
            self.trig2_done2(),
            self.trig3_done2(),
...
impl defmt::Format for Trig0Chain10 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig0Chain10 {{ csel0: {:?}, hwts0: {:?}, b2b0: {:?}, ie0: {:?}, csel1: {:?}, hwts1: {:?}, b2b1: {:?}, ie1: {:?} }}",
            self.csel0(),
            self.hwts0(),
            self.b2b0(),
            self.ie0(),
...
impl defmt::Format for Trig0Chain32 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig0Chain32 {{ csel2: {:?}, hwts2: {:?}, b2b2: {:?}, ie2: {:?}, csel3: {:?}, hwts3: {:?}, b2b3: {:?}, ie3: {:?} }}",
            self.csel2(),
            self.hwts2(),
            self.b2b2(),
            self.ie2(),
...
impl defmt::Format for Trig0Chain54 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig0Chain54 {{ csel4: {:?}, hwts4: {:?}, b2b4: {:?}, ie4: {:?}, csel5: {:?}, hwts5: {:?}, b2b5: {:?}, ie5: {:?} }}",
            self.csel4(),
            self.hwts4(),
            self.b2b4(),
            self.ie4(),
...
impl defmt::Format for Trig0Chain76 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig0Chain76 {{ csel6: {:?}, hwts6: {:?}, b2b6: {:?}, ie6: {:?}, csel7: {:?}, hwts7: {:?}, b2b7: {:?}, ie7: {:?} }}",
            self.csel6(),
            self.hwts6(),
            self.b2b6(),
            self.ie6(),
...
impl defmt::Format for Trig1Chain10 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig1Chain10 {{ csel0: {:?}, hwts0: {:?}, b2b0: {:?}, ie0: {:?}, csel1: {:?}, hwts1: {:?}, b2b1: {:?}, ie1: {:?} }}",
            self.csel0(),
            self.hwts0(),
            self.b2b0(),
            self.ie0(),
...
impl defmt::Format for Trig1Chain32 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig1Chain32 {{ csel2: {:?}, hwts2: {:?}, b2b2: {:?}, ie2: {:?}, csel3: {:?}, hwts3: {:?}, b2b3: {:?}, ie3: {:?} }}",
            self.csel2(),
            self.hwts2(),
            self.b2b2(),
            self.ie2(),
...
impl defmt::Format for Trig1Chain54 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig1Chain54 {{ csel4: {:?}, hwts4: {:?}, b2b4: {:?}, ie4: {:?}, csel5: {:?}, hwts5: {:?}, b2b5: {:?}, ie5: {:?} }}",
            self.csel4(),
            self.hwts4(),
            self.b2b4(),
            self.ie4(),
...
impl defmt::Format for Trig1Chain76 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig1Chain76 {{ csel6: {:?}, hwts6: {:?}, b2b6: {:?}, ie6: {:?}, csel7: {:?}, hwts7: {:?}, b2b7: {:?}, ie7: {:?} }}",
            self.csel6(),
            self.hwts6(),
            self.b2b6(),
            self.ie6(),
...
impl defmt::Format for Trig2Chain10 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig2Chain10 {{ csel0: {:?}, hwts0: {:?}, b2b0: {:?}, ie0: {:?}, csel1: {:?}, hwts1: {:?}, b2b1: {:?}, ie1: {:?} }}",
            self.csel0(),
            self.hwts0(),
            self.b2b0(),
            self.ie0(),
...
impl defmt::Format for Trig2Chain32 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig2Chain32 {{ csel2: {:?}, hwts2: {:?}, b2b2: {:?}, ie2: {:?}, csel3: {:?}, hwts3: {:?}, b2b3: {:?}, ie3: {:?} }}",
            self.csel2(),
            self.hwts2(),
            self.b2b2(),
            self.ie2(),
...
impl defmt::Format for Trig2Chain54 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig2Chain54 {{ csel4: {:?}, hwts4: {:?}, b2b4: {:?}, ie4: {:?}, csel5: {:?}, hwts5: {:?}, b2b5: {:?}, ie5: {:?} }}",
            self.csel4(),
            self.hwts4(),
            self.b2b4(),
            self.ie4(),
...
impl defmt::Format for Trig2Chain76 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig2Chain76 {{ csel6: {:?}, hwts6: {:?}, b2b6: {:?}, ie6: {:?}, csel7: {:?}, hwts7: {:?}, b2b7: {:?}, ie7: {:?} }}",
            self.csel6(),
            self.hwts6(),
            self.b2b6(),
            self.ie6(),
...
impl defmt::Format for Trig3Chain10 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig3Chain10 {{ csel0: {:?}, hwts0: {:?}, b2b0: {:?}, ie0: {:?}, csel1: {:?}, hwts1: {:?}, b2b1: {:?}, ie1: {:?} }}",
            self.csel0(),
            self.hwts0(),
            self.b2b0(),
            self.ie0(),
...
impl defmt::Format for Trig3Chain32 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig3Chain32 {{ csel2: {:?}, hwts2: {:?}, b2b2: {:?}, ie2: {:?}, csel3: {:?}, hwts3: {:?}, b2b3: {:?}, ie3: {:?} }}",
            self.csel2(),
            self.hwts2(),
            self.b2b2(),
            self.ie2(),
...
impl defmt::Format for Trig3Chain54 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig3Chain54 {{ csel4: {:?}, hwts4: {:?}, b2b4: {:?}, ie4: {:?}, csel5: {:?}, hwts5: {:?}, b2b5: {:?}, ie5: {:?} }}",
            self.csel4(),
            self.hwts4(),
            self.b2b4(),
            self.ie4(),
...
impl defmt::Format for Trig3Chain76 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Trig3Chain76 {{ csel6: {:?}, hwts6: {:?}, b2b6: {:?}, ie6: {:?}, csel7: {:?}, hwts7: {:?}, b2b7: {:?}, ie7: {:?} }}",
            self.csel6(),
            self.hwts6(),
            self.b2b6(),
            self.ie6(),
