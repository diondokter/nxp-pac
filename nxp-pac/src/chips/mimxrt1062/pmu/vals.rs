...
impl Misc1ClrLvds2ClkSel {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Misc1ClrLvds2ClkSel {
        unsafe { core::mem::transmute(val & 0x1f) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Misc1ClrLvds2ClkSel {
    #[inline(always)]
    fn from(val: u8) -> Misc1ClrLvds2ClkSel {
        Misc1ClrLvds2ClkSel::from_bits(val)
    }
}
impl From<Misc1ClrLvds2ClkSel> for u8 {
    #[inline(always)]
    fn from(val: Misc1ClrLvds2ClkSel) -> u8 {
        Misc1ClrLvds2ClkSel::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl Misc1Lvds2ClkSel {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Misc1Lvds2ClkSel {
        unsafe { core::mem::transmute(val & 0x1f) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Misc1Lvds2ClkSel {
    #[inline(always)]
    fn from(val: u8) -> Misc1Lvds2ClkSel {
        Misc1Lvds2ClkSel::from_bits(val)
    }
}
impl From<Misc1Lvds2ClkSel> for u8 {
    #[inline(always)]
    fn from(val: Misc1Lvds2ClkSel) -> u8 {
        Misc1Lvds2ClkSel::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
...
impl Misc1SetLvds2ClkSel {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Misc1SetLvds2ClkSel {
        unsafe { core::mem::transmute(val & 0x1f) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl Misc1TogLvds2ClkSel {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Misc1TogLvds2ClkSel {
        unsafe { core::mem::transmute(val & 0x1f) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Misc1TogLvds2ClkSel {
    #[inline(always)]
    fn from(val: u8) -> Misc1TogLvds2ClkSel {
        Misc1TogLvds2ClkSel::from_bits(val)
    }
}
impl From<Misc1TogLvds2ClkSel> for u8 {
    #[inline(always)]
    fn from(val: Misc1TogLvds2ClkSel) -> u8 {
        Misc1TogLvds2ClkSel::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
