...
impl defmt::Format for Hplr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Hplr {{ zmk_wsl: {:?}, zmk_rsl: {:?}, srtc_sl: {:?}, lpcalb_sl: {:?}, mc_sl: {:?}, gpr_sl: {:?}, lpsvcr_sl: {:?}, lpsecr_sl: {:?}, mks_sl: {:?}, hpsvcr_l: {:?}, hpsicr_l: {:?}, hac_l: {:?} }}",
            self.zmk_wsl(),
            self.zmk_rsl(),
            self.srtc_sl(),
            self.lpcalb_sl(),
...
impl defmt::Format for Lplr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Lplr {{ zmk_whl: {:?}, zmk_rhl: {:?}, srtc_hl: {:?}, lpcalb_hl: {:?}, mc_hl: {:?}, gpr_hl: {:?}, lpsvcr_hl: {:?}, lpsecr_hl: {:?}, mks_hl: {:?} }}",
            self.zmk_whl(),
            self.zmk_rhl(),
            self.srtc_hl(),
            self.lpcalb_hl(),
...
impl defmt::Format for Lpsecr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Lpsecr {{ srtcr_en: {=bool:?}, mcr_en: {=bool:?}, pfd_observ: {=bool:?}, por_observ: {=bool:?}, ltdc: {=u8:?}, htdc: {=u8:?}, vrc: {=u8:?}, oscb: {=bool:?} }}",
            self.srtcr_en(),
            self.mcr_en(),
            self.pfd_observ(),
            self.por_observ(),
...
impl defmt::Format for Lpsr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Lpsr {{ lpta: {:?}, srtcr: {:?}, mcr: {:?}, lvd: {:?}, esvd: {:?}, eo: {:?}, spof: {:?}, spon: {:?}, lpns: {:?}, lps: {:?} }}",
            self.lpta(),
            self.srtcr(),
            self.mcr(),
            self.lvd(),
