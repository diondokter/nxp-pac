...
pub enum FirctcfgTrimsrc {
    #[doc = "USB. This option provides fine trim value directly from USB, without using clock."]
    USB0 = 0x0,
    #[doc = "USB Start of Frame (1 KHz). This option does not use TRIMDIV."]
    USB1 = 0x01,
...
pub enum Roscerr {
    ...
    #[doc = "ROSC Clock Monitor is enabled and detected an RTC loss of clock error has detected an error."]
...
pub enum Source {
    #[doc = "SOSC."]
    SOSC = 0x0,
    #[doc = "FIRC 48 MHz clock. FIRC_SCLK_PERIPH_EN needs to be set to use FIRC 48 MHz clock."]
    FIRC = 0x01,
    _RESERVED_2 = 0x02,
