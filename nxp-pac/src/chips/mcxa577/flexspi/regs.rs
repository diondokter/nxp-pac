...
impl defmt::Format for Ahbcr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbcr {{ aparen: {:?}, clrahbrxbuf: {:?}, clrahbtxbuf: {:?}, cachableen: {:?}, bufferableen: {:?}, prefetchen: {:?}, readaddropt: {:?}, resumedisable: {:?}, readszalign: {:?}, aflashbase: {=u8:?} }}",
            self.aparen(),
            self.clrahbrxbuf(),
            self.clrahbtxbuf(),
            self.cachableen(),
...
impl defmt::Format for Ahbrxbuf0cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf0cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, prefetchen: {:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.prefetchen()
...
impl defmt::Format for Ahbrxbuf1cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf1cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, prefetchen: {:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.prefetchen()
...
impl defmt::Format for Ahbrxbuf2cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf2cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, prefetchen: {:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.prefetchen()
...
impl defmt::Format for Ahbrxbuf3cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf3cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, prefetchen: {:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.prefetchen()
...
impl defmt::Format for Ahbrxbuf4cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf4cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, prefetchen: {:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.prefetchen()
...
impl defmt::Format for Ahbrxbuf5cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf5cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, prefetchen: {:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.prefetchen()
...
impl defmt::Format for Ahbrxbuf6cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf6cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, prefetchen: {:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.prefetchen()
...
impl defmt::Format for Ahbrxbuf7cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf7cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, prefetchen: {:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.prefetchen()
...
impl defmt::Format for Flsha1cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Flsha1cr0 {{ flshsz: {=u32:?}, splitwren: {=bool:?}, splitrden: {=bool:?} }}",
            self.flshsz(),
            self.splitwren(),
            self.splitrden()
        )
...
impl defmt::Format for Flsha2cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Flsha2cr0 {{ flshsz: {=u32:?}, splitwren: {=bool:?}, splitrden: {=bool:?} }}",
            self.flshsz(),
            self.splitwren(),
            self.splitrden()
        )
...
impl defmt::Format for Flshb1cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Flshb1cr0 {{ flshsz: {=u32:?}, splitwren: {=bool:?}, splitrden: {=bool:?} }}",
            self.flshsz(),
            self.splitwren(),
            self.splitrden()
        )
...
impl defmt::Format for Flshb2cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Flshb2cr0 {{ flshsz: {=u32:?}, splitwren: {=bool:?}, splitrden: {=bool:?} }}",
            self.flshsz(),
            self.splitwren(),
            self.splitrden()
        )
...
impl defmt::Format for Flshcr4 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Flshcr4 {{ wmopt1: {=bool:?}, wmopt2: {:?}, wmena: {:?}, wmenb: {:?} }}",
            self.wmopt1(),
            self.wmopt2(),
            self.wmena(),
            self.wmenb()
...
impl defmt::Format for Inten {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Inten {{ ipcmddoneen: {:?}, ipcmdgeen: {:?}, ahbcmdgeen: {:?}, ipcmderren: {:?}, ahbcmderren: {:?}, iprxwaen: {:?}, iptxween: {:?}, datalearnfailen: {:?}, sckstopbyrden: {:?}, sckstopbywren: {:?}, ahbbustimeouten: {:?}, seqtimeouten: {:?}, ahbgcmerren: {:?} }}",
            self.ipcmddoneen(),
            self.ipcmdgeen(),
            self.ahbcmdgeen(),
            self.ipcmderren(),
...
impl defmt::Format for Intr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Intr {{ ipcmddone: {=bool:?}, ipcmdge: {=bool:?}, ahbcmdge: {=bool:?}, ipcmderr: {=bool:?}, ahbcmderr: {=bool:?}, iprxwa: {=bool:?}, iptxwe: {=bool:?}, datalearnfail: {=bool:?}, sckstopbyrd: {=bool:?}, sckstopbywr: {=bool:?}, ahbbustimeout: {=bool:?}, seqtimeout: {=bool:?}, ahbgcmerr: {=bool:?} }}",
            self.ipcmddone(),
            self.ipcmdge(),
            self.ahbcmdge(),
            self.ipcmderr(),
...
impl defmt::Format for Mcr2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Mcr2 {{ clrahbbufopt: {:?}, clrlearnphase: {:?}, samedeviceen: {:?}, sckbdiffopt: {:?}, resumewait: {=u8:?} }}",
            self.clrahbbufopt(),
            self.clrlearnphase(),
            self.samedeviceen(),
            self.sckbdiffopt(),
...
impl Sts2 {
    ...
    #[doc = "Delay Cell number of Flash A Reference Delay Line indication is not one-hot."]
    #[must_use]
    #[inline(always)]
    pub const fn aref_one_hot_err(&self) -> super::vals::ArefOneHotErr {
        let val = (self.0 >> 14usize) & 0x01;
        super::vals::ArefOneHotErr::from_bits(val as u8)
    }
    #[doc = "Delay Cell number of Flash A Reference Delay Line indication is not one-hot."]
    #[inline(always)]
    pub const fn set_aref_one_hot_err(&mut self, val: super::vals::ArefOneHotErr) {
        self.0 = (self.0 & !(0x01 << 14usize)) | (((val.to_bits() as u32) & 0x01) << 14usize);
    }
    #[doc = "Delay Cell number of Flash A Reference Delay Line indication is all zero."]
    #[must_use]
    #[inline(always)]
    pub const fn aref_all_zero_err(&self) -> super::vals::ArefAllZeroErr {
        let val = (self.0 >> 15usize) & 0x01;
        super::vals::ArefAllZeroErr::from_bits(val as u8)
    }
    #[doc = "Delay Cell number of Flash A Reference Delay Line indication is all zero."]
    #[inline(always)]
    pub const fn set_aref_all_zero_err(&mut self, val: super::vals::ArefAllZeroErr) {
        self.0 = (self.0 & !(0x01 << 15usize)) | (((val.to_bits() as u32) & 0x01) << 15usize);
    }
    ...
    #[doc = "Delay Cell number of Flash B Reference Delay Line indication is not one-hot."]
    #[must_use]
    #[inline(always)]
    pub const fn bref_one_hot_err(&self) -> super::vals::BrefOneHotErr {
        let val = (self.0 >> 30usize) & 0x01;
        super::vals::BrefOneHotErr::from_bits(val as u8)
    }
    #[doc = "Delay Cell number of Flash B Reference Delay Line indication is not one-hot."]
    #[inline(always)]
    pub const fn set_bref_one_hot_err(&mut self, val: super::vals::BrefOneHotErr) {
        self.0 = (self.0 & !(0x01 << 30usize)) | (((val.to_bits() as u32) & 0x01) << 30usize);
    }
    #[doc = "Delay Cell number of Flash B Reference Delay Line indication is all zero."]
    #[must_use]
    #[inline(always)]
    pub const fn bref_all_zero_err(&self) -> super::vals::BrefAllZeroErr {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::BrefAllZeroErr::from_bits(val as u8)
    }
    #[doc = "Delay Cell number of Flash B Reference Delay Line indication is all zero."]
    #[inline(always)]
    pub const fn set_bref_all_zero_err(&mut self, val: super::vals::BrefAllZeroErr) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
...
impl core::fmt::Debug for Sts2 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Sts2")
            ...
            .field("aref_one_hot_err", &self.aref_one_hot_err())
            .field("aref_all_zero_err", &self.aref_all_zero_err())
            .field("bslvlock", &self.bslvlock())
            .field("breflock", &self.breflock())
            .field("bslvsel", &self.bslvsel())
            .field("brefsel", &self.brefsel())
            .field("bref_one_hot_err", &self.bref_one_hot_err())
            .field("bref_all_zero_err", &self.bref_all_zero_err())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Sts2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Sts2 {{ aslvlock: {:?}, areflock: {:?}, aslvsel: {=u8:?}, arefsel: {=u8:?}, aref_one_hot_err: {:?}, aref_all_zero_err: {:?}, bslvlock: {:?}, breflock: {:?}, bslvsel: {=u8:?}, brefsel: {=u8:?}, bref_one_hot_err: {:?}, bref_all_zero_err: {:?} }}",
            self.aslvlock(),
            self.areflock(),
            self.aslvsel(),
            self.arefsel(),
            self.aref_one_hot_err(),
            self.aref_all_zero_err(),
            self.bslvlock(),
            self.breflock(),
            self.bslvsel(),
            self.brefsel(),
            self.bref_one_hot_err(),
            self.bref_all_zero_err()
        )
    }
}
