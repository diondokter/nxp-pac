...
impl defmt::Format for Endptctrl1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Endptctrl1 {{ rxs: {=bool:?}, rxd: {=bool:?}, rxt: {:?}, rxi: {:?}, rxr: {=bool:?}, rxe: {=bool:?}, txs: {=bool:?}, txd: {=bool:?}, txt: {:?}, txi: {:?}, txr: {=bool:?}, txe: {=bool:?} }}",
            self.rxs(),
            self.rxd(),
            self.rxt(),
            self.rxi(),
...
impl defmt::Format for Endptctrl2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Endptctrl2 {{ rxs: {=bool:?}, rxd: {=bool:?}, rxt: {:?}, rxi: {:?}, rxr: {=bool:?}, rxe: {=bool:?}, txs: {=bool:?}, txd: {=bool:?}, txt: {:?}, txi: {:?}, txr: {=bool:?}, txe: {=bool:?} }}",
            self.rxs(),
            self.rxd(),
            self.rxt(),
            self.rxi(),
...
impl defmt::Format for Endptctrl3 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Endptctrl3 {{ rxs: {=bool:?}, rxd: {=bool:?}, rxt: {:?}, rxi: {:?}, rxr: {=bool:?}, rxe: {=bool:?}, txs: {=bool:?}, txd: {=bool:?}, txt: {:?}, txi: {:?}, txr: {=bool:?}, txe: {=bool:?} }}",
            self.rxs(),
            self.rxd(),
            self.rxt(),
            self.rxi(),
...
impl defmt::Format for Endptctrl5 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Endptctrl5 {{ rxs: {=bool:?}, rxd: {=bool:?}, rxt: {:?}, rxi: {:?}, rxr: {=bool:?}, rxe: {=bool:?}, txs: {=bool:?}, txd: {=bool:?}, txt: {:?}, txi: {:?}, txr: {=bool:?}, txe: {=bool:?} }}",
            self.rxs(),
            self.rxd(),
            self.rxt(),
            self.rxi(),
...
impl defmt::Format for Endptctrl6 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Endptctrl6 {{ rxs: {=bool:?}, rxd: {=bool:?}, rxt: {:?}, rxi: {:?}, rxr: {=bool:?}, rxe: {=bool:?}, txs: {=bool:?}, txd: {=bool:?}, txt: {:?}, txi: {:?}, txr: {=bool:?}, txe: {=bool:?} }}",
            self.rxs(),
            self.rxd(),
            self.rxt(),
            self.rxi(),
...
impl defmt::Format for Endptctrl7 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Endptctrl7 {{ rxs: {=bool:?}, rxd: {=bool:?}, rxt: {:?}, rxi: {:?}, rxr: {=bool:?}, rxe: {=bool:?}, txs: {=bool:?}, txd: {=bool:?}, txt: {:?}, txi: {:?}, txr: {=bool:?}, txe: {=bool:?} }}",
            self.rxs(),
            self.rxd(),
            self.rxt(),
            self.rxi(),
...
impl defmt::Format for Portsc1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Portsc1 {{ ccs: {:?}, csc: {=bool:?}, pe: {=bool:?}, pec: {=bool:?}, oca: {=bool:?}, occ: {=bool:?}, fpr: {=bool:?}, susp: {=bool:?}, pr: {=bool:?}, hsp: {=bool:?}, ls: {:?}, pp: {=bool:?}, po: {=bool:?}, pic: {:?}, ptc: {:?}, wkcn: {=bool:?}, wkdc: {=bool:?}, wkoc: {=bool:?}, phcd: {:?}, pfsc: {:?}, pts_2: {=bool:?}, pspd: {:?}, ptw: {:?}, sts: {=bool:?}, pts_1: {=u8:?} }}",
            self.ccs(),
            self.csc(),
            self.pe(),
            self.pec(),
...
impl defmt::Format for Usbcmd {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Usbcmd {{ rs: {:?}, rst: {=bool:?}, fs_1: {=u8:?}, pse: {:?}, ase: {:?}, iaa: {=bool:?}, asp: {=u8:?}, aspe: {=bool:?}, sutw: {=bool:?}, atdtw: {=bool:?}, fs_2: {=bool:?}, itc: {:?} }}",
            self.rs(),
            self.rst(),
            self.fs_1(),
            self.pse(),
...
impl defmt::Format for Usbintr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Usbintr {{ ue: {=bool:?}, uee: {=bool:?}, pce: {=bool:?}, fre: {=bool:?}, see: {=bool:?}, aae: {=bool:?}, ure: {=bool:?}, sre: {=bool:?}, sle: {=bool:?}, nake: {=bool:?}, uaie: {=bool:?}, upie: {=bool:?}, tie0: {=bool:?}, tie1: {=bool:?}, lpm_l1_exitie: {=bool:?}, lpm_l1_entryie: {=bool:?}, lpm_dev_rcvdie: {=bool:?}, lpm_hst_compie: {=bool:?} }}",
            self.ue(),
            self.uee(),
            self.pce(),
            self.fre(),
...
impl defmt::Format for Usbsts {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Usbsts {{ ui: {:?}, uei: {:?}, pci: {:?}, fri: {:?}, sei: {:?}, aai: {:?}, uri: {:?}, sri: {:?}, sli: {:?}, ulpii: {:?}, hch: {=bool:?}, rcl: {=bool:?}, ps: {=bool:?}, as_: {=bool:?}, naki: {=bool:?}, uai: {:?}, upi: {:?}, ti0: {:?}, ti1: {:?}, lpm_l1_exiti: {:?}, lpm_l1_entryi: {:?}, lpm_dev_rcvdi: {:?}, lpm_hst_compi: {:?} }}",
            self.ui(),
            self.uei(),
            self.pci(),
            self.fri(),
