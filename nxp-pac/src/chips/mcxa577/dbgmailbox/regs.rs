...
impl Csw {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn soft_reset(&self) -> super::vals::SoftReset {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::SoftReset::from_bits(val as u8)
    }
    #[doc = "Soft Reset."]
    #[inline(always)]
    pub const fn set_soft_reset(&mut self, val: super::vals::SoftReset) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Chip Reset Request."]
    #[must_use]
    #[inline(always)]
    pub const fn chip_reset_req(&self) -> super::vals::ChipResetReq {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::ChipResetReq::from_bits(val as u8)
    }
    #[doc = "Chip Reset Request."]
    #[inline(always)]
    pub const fn set_chip_reset_req(&mut self, val: super::vals::ChipResetReq) {
