...
impl defmt::Format for Ctrl1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ctrl1 {{ propseg: {=u8:?}, lom: {:?}, lbuf: {:?}, tsyn: {:?}, boffrec: {:?}, smp: {:?}, rom: {=bool:?}, rwrnmsk: {:?}, twrnmsk: {:?}, lpb: {:?}, errmsk: {:?}, boffmsk: {:?}, pseg2: {=u8:?}, pseg1: {=u8:?}, rjw: {=u8:?}, presdiv: {=u8:?} }}",
            self.propseg(),
            self.lom(),
            self.lbuf(),
            self.tsyn(),
...
impl Ctrl2 {
    #[doc = "Number of Retransmission Requests."]
    #[must_use]
    #[inline(always)]
    pub const fn retry(&self) -> super::vals::Retry {
        let val = (self.0 >> 2usize) & 0x07;
        super::vals::Retry::from_bits(val as u8)
    }
    #[doc = "Number of Retransmission Requests."]
    #[inline(always)]
    pub const fn set_retry(&mut self, val: super::vals::Retry) {
        self.0 = (self.0 & !(0x07 << 2usize)) | (((val.to_bits() as u32) & 0x07) << 2usize);
    }
    #[doc = "Fault reaction."]
    #[must_use]
    #[inline(always)]
    pub const fn flt_rxn(&self) -> bool {
        let val = (self.0 >> 10usize) & 0x01;
        val != 0
    }
    #[doc = "Fault reaction."]
    ...
    #[must_use]
    #[inline(always)]
    pub const fn timer_src(&self) -> super::vals::TimerSrc {
        let val = (self.0 >> 15usize) & 0x01;
        super::vals::TimerSrc::from_bits(val as u8)
    }
    #[doc = "Timer Source."]
    #[inline(always)]
    pub const fn set_timer_src(&mut self, val: super::vals::TimerSrc) {
        self.0 = (self.0 & !(0x01 << 15usize)) | (((val.to_bits() as u32) & 0x01) << 15usize);
    }
...
impl defmt::Format for Ctrl2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ctrl2 {{ retry: {:?}, flt_rxn: {=bool:?}, edfltdis: {:?}, isocanfden: {:?}, bte: {=bool:?}, prexcen: {=bool:?}, timer_src: {:?}, eacen: {:?}, rrs: {:?}, mrp: {:?}, tasd: {=u8:?}, rffn: {=u8:?}, boffdonemsk: {=bool:?}, errmsk_fast: {=bool:?} }}",
            self.retry(),
            self.flt_rxn(),
            self.edfltdis(),
            self.isocanfden(),
...
impl Esr1 {
    ...
    #[doc = "Active to Passive State."]
    #[must_use]
    #[inline(always)]
    pub const fn atp(&self) -> bool {
        let val = (self.0 >> 22usize) & 0x01;
        val != 0
    }
    #[doc = "Active to Passive State."]
    #[inline(always)]
    pub const fn set_atp(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
    }
    #[doc = "Passive to Active State."]
    #[must_use]
    #[inline(always)]
    pub const fn pta(&self) -> bool {
        let val = (self.0 >> 23usize) & 0x01;
        val != 0
    }
    #[doc = "Passive to Active State."]
    #[inline(always)]
    pub const fn set_pta(&mut self, val: bool) {
...
impl defmt::Format for Esr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Esr1 {{ wakint: {=bool:?}, errint: {=bool:?}, boffint: {=bool:?}, rx: {=bool:?}, fltconf: {:?}, tx: {:?}, idle: {:?}, rxwrn: {:?}, txwrn: {:?}, stferr: {:?}, frmerr: {:?}, crcerr: {:?}, ackerr: {:?}, bit0err: {:?}, bit1err: {:?}, rwrnint: {:?}, twrnint: {:?}, synch: {:?}, boffdoneint: {:?}, errint_fast: {:?}, errovr: {:?}, atp: {=bool:?}, pta: {=bool:?}, stferr_fast: {:?}, frmerr_fast: {:?}, crcerr_fast: {:?}, bit0err_fast: {:?}, bit1err_fast: {:?} }}",
            self.wakint(),
            self.errint(),
            self.boffint(),
            self.rx(),
...
impl Esr2 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn rx_pin_st(&self) -> super::vals::RxPinSt {
        let val = (self.0 >> 12usize) & 0x01;
        super::vals::RxPinSt::from_bits(val as u8)
    }
    #[doc = "RX Pin Status."]
    #[inline(always)]
    pub const fn set_rx_pin_st(&mut self, val: super::vals::RxPinSt) {
        self.0 = (self.0 & !(0x01 << 12usize)) | (((val.to_bits() as u32) & 0x01) << 12usize);
    }
...
impl core::fmt::Debug for Esr2 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Esr2")
            .field("rx_pin_st", &self.rx_pin_st())
            .field("imb", &self.imb())
            .field("vps", &self.vps())
...
impl defmt::Format for Esr2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Esr2 {{ rx_pin_st: {:?}, imb: {:?}, vps: {=bool:?}, lptm: {=u8:?} }}",
            self.rx_pin_st(),
            self.imb(),
            self.vps(),
            self.lptm()
...
impl core::fmt::Debug for Et {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Et").field("timer", &self.timer()).finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Et {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Et {{ timer: {=u32:?} }}", self.timer())
    }
}
...
#[doc = "Fault Confinement Interrupt Enable."]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct FltconfIe(pub u32);
impl FltconfIe {
    #[doc = "Active to Passive Interrupt Enable."]
    #[must_use]
    #[inline(always)]
    pub const fn atp_ie(&self) -> bool {
        let val = (self.0 >> 0usize) & 0x01;
        val != 0
    }
    #[doc = "Active to Passive Interrupt Enable."]
    ...
    #[doc = "Passive to Active Interrupt Enable."]
    #[must_use]
    #[inline(always)]
    pub const fn pta_ie(&self) -> bool {
        let val = (self.0 >> 1usize) & 0x01;
        val != 0
    }
    #[doc = "Passive to Active Interrupt Enable."]
...
impl Default for FltconfIe {
    #[inline(always)]
    fn default() -> FltconfIe {
        FltconfIe(0)
    }
}
impl core::fmt::Debug for FltconfIe {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FltconfIe")
            .field("atp_ie", &self.atp_ie())
            .field("pta_ie", &self.pta_ie())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for FltconfIe {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "FltconfIe {{ atp_ie: {=bool:?}, pta_ie: {=bool:?} }}",
            self.atp_ie(),
            self.pta_ie()
        )
    }
...
impl Mcr {
    ...
    #[doc = "TX Pin Override Enable."]
    #[must_use]
    #[inline(always)]
    pub const fn tpoe(&self) -> bool {
        let val = (self.0 >> 7usize) & 0x01;
        val != 0
    }
    #[doc = "TX Pin Override Enable."]
    #[inline(always)]
    pub const fn set_tpoe(&mut self, val: bool) {
    ...
    #[doc = "TX Pin Override Value."]
    #[must_use]
    #[inline(always)]
    pub const fn tpov(&self) -> super::vals::Tpov {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::Tpov::from_bits(val as u8)
    }
    #[doc = "TX Pin Override Value."]
    #[inline(always)]
    pub const fn set_tpov(&mut self, val: super::vals::Tpov) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
...
impl core::fmt::Debug for Mcr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Mcr")
            ...
            .field("tpoe", &self.tpoe())
            .field("idam", &self.idam())
            .field("tpov", &self.tpov())
...
impl defmt::Format for Mcr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Mcr {{ maxmb: {=u8:?}, tpoe: {=bool:?}, idam: {:?}, tpov: {:?}, fden: {:?}, aen: {:?}, lprioen: {:?}, pnet_en: {:?}, dma: {:?}, irmq: {:?}, srxdis: {:?}, doze: {:?}, waksrc: {=bool:?}, lpmack: {:?}, wrnen: {:?}, slfwak: {:?}, supv: {:?}, frzack: {:?}, softrst: {:?}, wakmsk: {:?}, notrdy: {:?}, halt: {:?}, rfen: {:?}, frz: {:?}, mdis: {:?} }}",
            self.maxmb(),
            self.tpoe(),
            self.idam(),
            self.tpov(),
