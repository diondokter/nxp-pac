...
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum Retry {
    #[doc = "No retransmission."]
    RETRANSMISSION = 0x0,
    #[doc = "Count of re-transmission attempts."]
    COUNT_RETRY = 0x01,
    #[doc = "Count of re-transmission attempts."]
    COUNT_RETRY1 = 0x02,
    #[doc = "Count of re-transmission attempts."]
    ...
    #[doc = "Count of re-transmission attempts."]
    COUNT_RETRY5 = 0x06,
    #[doc = "Unlimited number of retransmission."]
    UNLIMIT_RETRY = 0x07,
}
impl Retry {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Retry {
...
impl From<u8> for Retry {
    #[inline(always)]
    fn from(val: u8) -> Retry {
        Retry::from_bits(val)
    }
}
impl From<Retry> for u8 {
    #[inline(always)]
    fn from(val: Retry) -> u8 {
        Retry::to_bits(val)
    }
}
#[repr(u8)]
...
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum RxPinSt {
    #[doc = "RX pin is in the dominant state."]
    DOMINANT = 0x0,
    #[doc = "RX pin is in a recessive state."]
    RECESSIVE = 0x01,
}
impl RxPinSt {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> RxPinSt {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for RxPinSt {
    #[inline(always)]
    fn from(val: u8) -> RxPinSt {
        RxPinSt::from_bits(val)
    }
}
impl From<RxPinSt> for u8 {
    #[inline(always)]
    fn from(val: RxPinSt) -> u8 {
        RxPinSt::to_bits(val)
    }
}
#[repr(u8)]
...
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum Tpov {
    #[doc = "TX pin is forced to be dominant."]
    DOMINANT = 0x0,
    #[doc = "TX pin is forced to be recessive."]
    RECESSIVE = 0x01,
}
impl Tpov {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Tpov {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Tpov {
    #[inline(always)]
    fn from(val: u8) -> Tpov {
        Tpov::from_bits(val)
    }
}
impl From<Tpov> for u8 {
    #[inline(always)]
    fn from(val: Tpov) -> u8 {
        Tpov::to_bits(val)
    }
