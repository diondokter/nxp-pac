...
impl Ccr0 {
    ...
    #[doc = "Comparator STOP Mode Enable."]
    #[must_use]
    #[inline(always)]
...
impl defmt::Format for Rrcr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Rrcr0 {{ rr_en: {=bool:?}, rr_nsam: {:?}, rr_clk_sel: {:?}, rr_initmod: {:?}, rr_sample_cnt: {:?}, rr_sample_threshold: {:?} }}",
            self.rr_en(),
            self.rr_nsam(),
            self.rr_clk_sel(),
            self.rr_initmod(),
