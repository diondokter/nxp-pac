...
impl Baud {
    ...
    #[doc = "32.768 KHz Mode Select."]
    #[must_use]
    #[inline(always)]
    pub const fn msel32k(&self) -> super::vals::Msel32k {
        let val = (self.0 >> 22usize) & 0x01;
        super::vals::Msel32k::from_bits(val as u8)
    }
    #[doc = "32.768 KHz Mode Select."]
    #[inline(always)]
    pub const fn set_msel32k(&mut self, val: super::vals::Msel32k) {
...
impl defmt::Format for Baud {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Baud {{ sbr: {=u16:?}, sbns: {:?}, rxedgie: {=bool:?}, lbkdie: {=bool:?}, resyncdis: {:?}, bothedge: {=bool:?}, matcfg: {:?}, ridmae: {=bool:?}, rdmae: {=bool:?}, msel32k: {:?}, tdmae: {=bool:?}, osr: {=u8:?}, m10: {=bool:?}, maen2: {=bool:?}, maen1: {=bool:?} }}",
            self.sbr(),
            self.sbns(),
            self.rxedgie(),
            self.lbkdie(),
...
impl Ctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn erlsmp(&self) -> super::vals::Erlsmp {
        let val = (self.0 >> 13usize) & 0x01;
        super::vals::Erlsmp::from_bits(val as u8)
    }
    #[doc = "Early Sample Selection."]
    #[inline(always)]
    pub const fn set_erlsmp(&mut self, val: super::vals::Erlsmp) {
        self.0 = (self.0 & !(0x01 << 13usize)) | (((val.to_bits() as u32) & 0x01) << 13usize);
    }
...
impl Global {
    ...
    #[doc = "Baud Select in 32.768 KHz Mode."]
    #[must_use]
    #[inline(always)]
    pub const fn bsel32k(&self) -> super::vals::Bsel32k {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Bsel32k::from_bits(val as u8)
    }
    #[doc = "Baud Select in 32.768 KHz Mode."]
    #[inline(always)]
    pub const fn set_bsel32k(&mut self, val: super::vals::Bsel32k) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Fixed Stop Bit Configuration."]
    #[must_use]
    #[inline(always)]
    pub const fn stpfix(&self) -> super::vals::Stpfix {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::Stpfix::from_bits(val as u8)
    }
    #[doc = "Fixed Stop Bit Configuration."]
    #[inline(always)]
    pub const fn set_stpfix(&mut self, val: super::vals::Stpfix) {
...
impl core::fmt::Debug for Global {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Global")
            .field("rst", &self.rst())
            .field("bsel32k", &self.bsel32k())
            .field("stpfix", &self.stpfix())
            .finish()
    }
}
#[cfg(feature = "defmt")]
