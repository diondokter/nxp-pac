...
impl defmt::Format for Misc1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc1 {{ pfd_480_autogate_en: {=bool:?}, pfd_528_autogate_en: {=bool:?}, irq_temppanic: {=bool:?}, irq_templow: {=bool:?}, irq_temphigh: {=bool:?}, irq_ana_bo: {=bool:?}, irq_dig_bo: {=bool:?} }}",
...
impl defmt::Format for Misc1Clr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc1Clr {{ pfd_480_autogate_en: {=bool:?}, pfd_528_autogate_en: {=bool:?}, irq_temppanic: {=bool:?}, irq_templow: {=bool:?}, irq_temphigh: {=bool:?}, irq_ana_bo: {=bool:?}, irq_dig_bo: {=bool:?} }}",
            self.pfd_480_autogate_en(),
            self.pfd_528_autogate_en(),
            self.irq_temppanic(),
            self.irq_templow(),
...
impl defmt::Format for Misc1Set {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc1Set {{ pfd_480_autogate_en: {=bool:?}, pfd_528_autogate_en: {=bool:?}, irq_temppanic: {=bool:?}, irq_templow: {=bool:?}, irq_temphigh: {=bool:?}, irq_ana_bo: {=bool:?}, irq_dig_bo: {=bool:?} }}",
            self.pfd_480_autogate_en(),
            self.pfd_528_autogate_en(),
            self.irq_temppanic(),
            self.irq_templow(),
...
impl defmt::Format for Misc1Tog {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc1Tog {{ pfd_480_autogate_en: {=bool:?}, pfd_528_autogate_en: {=bool:?}, irq_temppanic: {=bool:?}, irq_templow: {=bool:?}, irq_temphigh: {=bool:?}, irq_ana_bo: {=bool:?}, irq_dig_bo: {=bool:?} }}",
            self.pfd_480_autogate_en(),
            self.pfd_528_autogate_en(),
            self.irq_temppanic(),
            self.irq_templow(),
...
impl defmt::Format for Misc2Clr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc2Clr {{ reg0_bo_offset: {:?}, reg0_bo_status: {=bool:?}, reg0_enable_bo: {=bool:?}, reg0_ok: {=bool:?}, pll3_disable: {:?}, reg1_bo_offset: {:?}, reg1_bo_status: {=bool:?}, reg1_enable_bo: {=bool:?}, reg1_ok: {=bool:?}, audio_div_lsb: {:?}, reg2_bo_offset: {:?}, reg2_bo_status: {=bool:?}, reg2_enable_bo: {=bool:?}, reg2_ok: {=bool:?}, audio_div_msb: {:?}, reg0_step_time: {:?}, reg1_step_time: {:?}, reg2_step_time: {:?} }}",
            self.reg0_bo_offset(),
            self.reg0_bo_status(),
            self.reg0_enable_bo(),
            self.reg0_ok(),
...
impl defmt::Format for Misc2Set {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc2Set {{ reg0_bo_offset: {:?}, reg0_bo_status: {=bool:?}, reg0_enable_bo: {=bool:?}, reg0_ok: {=bool:?}, pll3_disable: {:?}, reg1_bo_offset: {:?}, reg1_bo_status: {=bool:?}, reg1_enable_bo: {=bool:?}, reg1_ok: {=bool:?}, audio_div_lsb: {:?}, reg2_bo_offset: {:?}, reg2_bo_status: {=bool:?}, reg2_enable_bo: {=bool:?}, reg2_ok: {=bool:?}, audio_div_msb: {:?}, reg0_step_time: {:?}, reg1_step_time: {:?}, reg2_step_time: {:?} }}",
            self.reg0_bo_offset(),
            self.reg0_bo_status(),
            self.reg0_enable_bo(),
            self.reg0_ok(),
...
impl defmt::Format for Misc2Tog {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc2Tog {{ reg0_bo_offset: {:?}, reg0_bo_status: {=bool:?}, reg0_enable_bo: {=bool:?}, reg0_ok: {=bool:?}, pll3_disable: {:?}, reg1_bo_offset: {:?}, reg1_bo_status: {=bool:?}, reg1_enable_bo: {=bool:?}, reg1_ok: {=bool:?}, audio_div_lsb: {:?}, reg2_bo_offset: {:?}, reg2_bo_status: {=bool:?}, reg2_enable_bo: {=bool:?}, reg2_ok: {=bool:?}, audio_div_msb: {:?}, reg0_step_time: {:?}, reg1_step_time: {:?}, reg2_step_time: {:?} }}",
            self.reg0_bo_offset(),
            self.reg0_bo_status(),
            self.reg0_enable_bo(),
            self.reg0_ok(),
...
impl core::fmt::Debug for PllEnet {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PllEnet")
            ...
            .field("bypass_clk_src", &self.bypass_clk_src())
            .field("bypass", &self.bypass())
            .field("enet_500m_ref_en", &self.enet_500m_ref_en())
            .field("lock", &self.lock())
            .finish()
    }
}
...
impl defmt::Format for PllEnet {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PllEnet {{ powerdown: {=bool:?}, bypass_clk_src: {:?}, bypass: {=bool:?}, enet_500m_ref_en: {=bool:?}, lock: {=bool:?} }}",
            self.powerdown(),
            self.bypass_clk_src(),
            self.bypass(),
            self.enet_500m_ref_en(),
            self.lock()
        )
    }
}
...
impl defmt::Format for PllEnetClr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PllEnetClr {{ powerdown: {=bool:?}, bypass_clk_src: {:?}, bypass: {=bool:?}, enet_500m_ref_en: {=bool:?}, lock: {=bool:?} }}",
            self.powerdown(),
            self.bypass_clk_src(),
            self.bypass(),
            self.enet_500m_ref_en(),
...
impl defmt::Format for PllEnetSet {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PllEnetSet {{ powerdown: {=bool:?}, bypass_clk_src: {:?}, bypass: {=bool:?}, enet_500m_ref_en: {=bool:?}, lock: {=bool:?} }}",
            self.powerdown(),
            self.bypass_clk_src(),
            self.bypass(),
            self.enet_500m_ref_en(),
...
impl defmt::Format for PllEnetTog {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "PllEnetTog {{ powerdown: {=bool:?}, bypass_clk_src: {:?}, bypass: {=bool:?}, enet_500m_ref_en: {=bool:?}, lock: {=bool:?} }}",
            self.powerdown(),
            self.bypass_clk_src(),
            self.bypass(),
            self.enet_500m_ref_en(),
