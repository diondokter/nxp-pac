...
impl defmt::Format for Hp0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Hp0 {{ hp_dma: {:?}, l_dma: {:?}, hp_lcdif: {:?}, l_lcdif: {:?}, hp_csi: {:?}, l_csi: {:?}, hp_pxp: {:?}, l_pxp: {:?}, hp_dcp: {:?}, l_dcp: {:?}, hp_enet: {:?}, l_enet: {:?}, hp_usdhc1: {:?}, l_usdhc1: {:?}, hp_usdhc2: {:?}, l_usdhc2: {:?}, hp_tpsmp: {:?}, l_tpsmp: {:?}, hp_usb: {:?}, l_usb: {:?} }}",
            self.hp_dma(),
            self.l_dma(),
            self.hp_lcdif(),
            self.l_lcdif(),
...
impl defmt::Format for Hpcontrol0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Hpcontrol0 {{ hpc_dma: {:?}, l_dma: {:?}, hpc_lcdif: {:?}, l_lcdif: {:?}, hpc_csi: {:?}, l_csi: {:?}, hpc_pxp: {:?}, l_pxp: {:?}, hpc_dcp: {:?}, l_dcp: {:?}, hpc_enet: {:?}, l_enet: {:?}, hpc_usdhc1: {:?}, l_usdhc1: {:?}, hpc_usdhc2: {:?}, l_usdhc2: {:?}, hpc_tpsmp: {:?}, l_tpsmp: {:?}, hpc_usb: {:?}, l_usb: {:?} }}",
            self.hpc_dma(),
            self.l_dma(),
            self.hpc_lcdif(),
            self.l_lcdif(),
...
impl defmt::Format for Sa {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Sa {{ nsa_dma: {:?}, l_dma: {:?}, nsa_lcdif: {:?}, l_lcdif: {:?}, nsa_csi: {:?}, l_csi: {:?}, nsa_pxp: {:?}, l_pxp: {:?}, nsa_dcp: {:?}, l_dcp: {:?}, nsa_enet: {:?}, l_enet: {:?}, nsa_usdhc1: {:?}, l_usdhc1: {:?}, nsa_usdhc2: {:?}, l_usdhc2: {:?}, nsa_tpsmp: {:?}, l_tpsmp: {:?}, nsa_usb: {:?}, l_usb: {:?} }}",
            self.nsa_dma(),
            self.l_dma(),
            self.nsa_lcdif(),
            self.l_lcdif(),
