...
impl defmt::Format for Misc2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc2 {{ reg0_bo_offset: {:?}, reg0_bo_status: {=bool:?}, reg0_enable_bo: {=bool:?}, pll3_disable: {=bool:?}, reg1_bo_offset: {:?}, reg1_bo_status: {=bool:?}, reg1_enable_bo: {=bool:?}, audio_div_lsb: {:?}, reg2_bo_offset: {:?}, reg2_bo_status: {=bool:?}, reg2_enable_bo: {=bool:?}, reg2_ok: {=bool:?}, audio_div_msb: {:?}, reg0_step_time: {:?}, reg1_step_time: {:?}, reg2_step_time: {:?} }}",
            self.reg0_bo_offset(),
            self.reg0_bo_status(),
            self.reg0_enable_bo(),
            self.pll3_disable(),
...
impl defmt::Format for Misc2Clr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc2Clr {{ reg0_bo_offset: {:?}, reg0_bo_status: {=bool:?}, reg0_enable_bo: {=bool:?}, pll3_disable: {=bool:?}, reg1_bo_offset: {:?}, reg1_bo_status: {=bool:?}, reg1_enable_bo: {=bool:?}, audio_div_lsb: {:?}, reg2_bo_offset: {:?}, reg2_bo_status: {=bool:?}, reg2_enable_bo: {=bool:?}, reg2_ok: {=bool:?}, audio_div_msb: {:?}, reg0_step_time: {:?}, reg1_step_time: {:?}, reg2_step_time: {:?} }}",
            self.reg0_bo_offset(),
            self.reg0_bo_status(),
            self.reg0_enable_bo(),
            self.pll3_disable(),
...
impl defmt::Format for Misc2Set {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc2Set {{ reg0_bo_offset: {:?}, reg0_bo_status: {=bool:?}, reg0_enable_bo: {=bool:?}, pll3_disable: {=bool:?}, reg1_bo_offset: {:?}, reg1_bo_status: {=bool:?}, reg1_enable_bo: {=bool:?}, audio_div_lsb: {:?}, reg2_bo_offset: {:?}, reg2_bo_status: {=bool:?}, reg2_enable_bo: {=bool:?}, reg2_ok: {=bool:?}, audio_div_msb: {:?}, reg0_step_time: {:?}, reg1_step_time: {:?}, reg2_step_time: {:?} }}",
            self.reg0_bo_offset(),
            self.reg0_bo_status(),
            self.reg0_enable_bo(),
            self.pll3_disable(),
...
impl defmt::Format for Misc2Tog {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Misc2Tog {{ reg0_bo_offset: {:?}, reg0_bo_status: {=bool:?}, reg0_enable_bo: {=bool:?}, pll3_disable: {=bool:?}, reg1_bo_offset: {:?}, reg1_bo_status: {=bool:?}, reg1_enable_bo: {=bool:?}, audio_div_lsb: {:?}, reg2_bo_offset: {:?}, reg2_bo_status: {=bool:?}, reg2_enable_bo: {=bool:?}, reg2_ok: {=bool:?}, audio_div_msb: {:?}, reg0_step_time: {:?}, reg1_step_time: {:?}, reg2_step_time: {:?} }}",
            self.reg0_bo_offset(),
            self.reg0_bo_status(),
            self.reg0_enable_bo(),
            self.pll3_disable(),
