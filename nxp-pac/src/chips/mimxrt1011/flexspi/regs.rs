...
impl Ahbcr {
    ...
    #[doc = "Clear the status/pointers of AHB TX Buffer. Auto-cleared. For internal use only."]
    #[must_use]
    #[inline(always)]
...
impl defmt::Format for Ahbrxbuf0cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf0cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, regionen: {=bool:?}, prefetchen: {=bool:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.regionen(),
...
impl defmt::Format for Ahbrxbuf1cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf1cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, regionen: {=bool:?}, prefetchen: {=bool:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.regionen(),
...
impl defmt::Format for Ahbrxbuf2cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf2cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, regionen: {=bool:?}, prefetchen: {=bool:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.regionen(),
...
impl defmt::Format for Ahbrxbuf3cr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrxbuf3cr0 {{ bufsz: {=u8:?}, mstrid: {=u8:?}, priority: {=u8:?}, regionen: {=bool:?}, prefetchen: {=bool:?} }}",
            self.bufsz(),
            self.mstrid(),
            self.priority(),
            self.regionen(),
...
impl Inten {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ahbbuserroren(&self) -> bool {
        let val = (self.0 >> 10usize) & 0x01;
        val != 0
    }
    #[doc = "AHB Bus error interrupt enable.Refer Interrupts chapter for more details."]
    #[inline(always)]
    pub const fn set_ahbbuserroren(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn keydoneen(&self) -> bool {
        let val = (self.0 >> 12usize) & 0x01;
        val != 0
    }
    #[doc = "OTFAD key blob processing done interrupt enable.Refer Interrupts chapter for more details."]
    #[inline(always)]
    pub const fn set_keydoneen(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
    }
    #[doc = "OTFAD key blob processing error interrupt enable.Refer Interrupts chapter for more details."]
    #[must_use]
    #[inline(always)]
    pub const fn keyerroren(&self) -> bool {
        let val = (self.0 >> 13usize) & 0x01;
        val != 0
    }
    #[doc = "OTFAD key blob processing error interrupt enable.Refer Interrupts chapter for more details."]
    #[inline(always)]
    pub const fn set_keyerroren(&mut self, val: bool) {
...
impl defmt::Format for Inten {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Inten {{ ipcmddoneen: {=bool:?}, ipcmdgeen: {=bool:?}, ahbcmdgeen: {=bool:?}, ipcmderren: {=bool:?}, ahbcmderren: {=bool:?}, iprxwaen: {=bool:?}, iptxween: {=bool:?}, sckstopbyrden: {=bool:?}, sckstopbywren: {=bool:?}, ahbbuserroren: {=bool:?}, seqtimeouten: {=bool:?}, keydoneen: {=bool:?}, keyerroren: {=bool:?} }}",
            self.ipcmddoneen(),
            self.ipcmdgeen(),
            self.ahbcmdgeen(),
            self.ipcmderren(),
...
impl defmt::Format for Intr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Intr {{ ipcmddone: {=bool:?}, ipcmdge: {=bool:?}, ahbcmdge: {=bool:?}, ipcmderr: {=bool:?}, ahbcmderr: {=bool:?}, iprxwa: {=bool:?}, iptxwe: {=bool:?}, sckstopbyrd: {=bool:?}, sckstopbywr: {=bool:?}, ahbbuserror: {=bool:?}, seqtimeout: {=bool:?}, keydone: {=bool:?}, keyerror: {=bool:?} }}",
            self.ipcmddone(),
            self.ipcmdge(),
            self.ahbcmdge(),
            self.ipcmderr(),
