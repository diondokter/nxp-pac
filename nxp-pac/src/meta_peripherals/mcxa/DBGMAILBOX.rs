...
impl Dbgmailbox {
    ...
    #[inline(always)]
    pub const fn csw(self) -> crate::pac::common::Reg<Csw, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "Request Value."]
    #[inline(always)]
    pub const fn request(self) -> crate::pac::common::Reg<Request, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "Return Value."]
    #[inline(always)]
    pub const fn return_(self) -> crate::pac::common::Reg<Return, crate::pac::common::RW> {
