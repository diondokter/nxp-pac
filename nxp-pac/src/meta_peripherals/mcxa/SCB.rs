...
impl Scb {
    ...
    #[inline(always)]
    pub const fn aircr(self) -> crate::pac::common::Reg<Aircr, crate::pac::common::RW> {
    ...
    #[inline(always)]
    pub const fn shcsr(self) -> crate::pac::common::Reg<Shcsr, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x24usize) as _) }
    }
    #[doc = "Coprocessor Access Control Register."]
    #[inline(always)]
    pub const fn cpacr(self) -> crate::pac::common::Reg<Cpacr, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x88usize) as _) }
    }
    #[doc = "Non-secure Access Control Register."]
    #[inline(always)]
    pub const fn nsacr(self) -> crate::pac::common::Reg<Nsacr, crate::pac::common::RW> {
