...
impl Smartdma0 {
    ...
    #[doc = "Boot Address."]
    #[inline(always)]
    pub const fn bootadr(self) -> crate::pac::common::Reg<Bootadr, crate::pac::common::RW> {
