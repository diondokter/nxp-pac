...
impl Pcr16 {
    ...
    pub const fn pv(&self) -> Pv {
        ...
        Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value."]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: Pv) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pfe(&self) -> Pcr16Pfe {
        let val = (self.0 >> 4usize) & 0x01;
        Pcr16Pfe::from_bits(val as u8)
    }
    #[doc = "Passive Filter Enable."]
    #[inline(always)]
    pub const fn set_pfe(&mut self, val: Pcr16Pfe) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dse1(&self) -> Pcr16Dse1 {
        let val = (self.0 >> 7usize) & 0x01;
        Pcr16Dse1::from_bits(val as u8)
    }
    #[doc = "Drive Strength Enable."]
    #[inline(always)]
    pub const fn set_dse1(&mut self, val: Pcr16Dse1) {
...
impl Pcr17 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pfe(&self) -> Pcr17Pfe {
        let val = (self.0 >> 4usize) & 0x01;
        Pcr17Pfe::from_bits(val as u8)
    }
    #[doc = "Passive Filter Enable."]
    #[inline(always)]
    pub const fn set_pfe(&mut self, val: Pcr17Pfe) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Open Drain Enable."]
    #[must_use]
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dse1(&self) -> Pcr17Dse1 {
        let val = (self.0 >> 7usize) & 0x01;
        Pcr17Dse1::from_bits(val as u8)
    }
    #[doc = "Drive Strength Enable."]
    #[inline(always)]
    pub const fn set_dse1(&mut self, val: Pcr17Dse1) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Pin Multiplex Control."]
    #[must_use]
