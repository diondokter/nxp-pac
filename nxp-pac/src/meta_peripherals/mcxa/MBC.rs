...
impl Mbc {
    ...
    pub const fn mbc0_memn_glbac0(
        self,
    ) -> crate::pac::common::Reg<MemnGlbac0, crate::pac::common::RW> {
    ...
    pub const fn mbc0_memn_glbac1(
        self,
    ) -> crate::pac::common::Reg<MemnGlbac1, crate::pac::common::RW> {
    ...
    pub const fn mbc0_memn_glbac2(
        self,
    ) -> crate::pac::common::Reg<MemnGlbac2, crate::pac::common::RW> {
    ...
    pub const fn mbc0_memn_glbac3(
        self,
    ) -> crate::pac::common::Reg<MemnGlbac3, crate::pac::common::RW> {
    ...
    pub const fn mbc0_memn_glbac4(
        self,
    ) -> crate::pac::common::Reg<MemnGlbac4, crate::pac::common::RW> {
    ...
    pub const fn mbc0_memn_glbac5(
        self,
    ) -> crate::pac::common::Reg<MemnGlbac5, crate::pac::common::RW> {
    ...
    pub const fn mbc0_memn_glbac6(
        self,
    ) -> crate::pac::common::Reg<MemnGlbac6, crate::pac::common::RW> {
    ...
    pub const fn mbc0_memn_glbac7(
        self,
    ) -> crate::pac::common::Reg<MemnGlbac7, crate::pac::common::RW> {
    ...
    pub const fn mbc0_dom0_mem0_blk_cfg_wn(
        self,
        n: usize,
    ) -> crate::pac::common::Reg<MemnBlkCfgW, crate::pac::common::RW> {
        assert!(n < 16usize);
        unsafe {
