...
impl Erm0 {
    ...
    #[inline(always)]
    pub const fn ear0(self) -> crate::pac::common::Reg<Ear0, crate::pac::common::R> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0100usize) as _) }
    }
    #[doc = "ERM Memory 0 Syndrome Register."]
    #[inline(always)]
    pub const fn syn0(self) -> crate::pac::common::Reg<Syn0, crate::pac::common::R> {
    ...
    #[inline(always)]
    pub const fn corr_err_cnt0(
        self,
    ) -> crate::pac::common::Reg<CorrErrCnt0, crate::pac::common::RW> {
    ...
    #[inline(always)]
    pub const fn corr_err_cnt1(
        self,
    ) -> crate::pac::common::Reg<CorrErrCnt1, crate::pac::common::RW> {
