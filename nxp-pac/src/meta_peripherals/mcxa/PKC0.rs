...
impl Pkc0 {
    ...
    #[doc = "Status Register."]
    #[inline(always)]
    pub const fn pkc_status(self) -> crate::pac::common::Reg<PkcStatus, crate::pac::common::R> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "Control Register."]
    #[inline(always)]
    pub const fn pkc_ctrl(self) -> crate::pac::common::Reg<PkcCtrl, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "Configuration register."]
    #[inline(always)]
    pub const fn pkc_cfg(self) -> crate::pac::common::Reg<PkcCfg, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "Mode register, parameter set 1."]
    #[inline(always)]
    pub const fn pkc_mode1(self) -> crate::pac::common::Reg<PkcMode1, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x10usize) as _) }
    }
    #[doc = "X+Y pointer register, parameter set 1."]
    #[inline(always)]
    pub const fn pkc_xyptr1(self) -> crate::pac::common::Reg<PkcXyptr1, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x14usize) as _) }
    }
    #[doc = "Z+R pointer register, parameter set 1."]
    #[inline(always)]
    pub const fn pkc_zrptr1(self) -> crate::pac::common::Reg<PkcZrptr1, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x18usize) as _) }
    }
    #[doc = "Length register, parameter set 1."]
    #[inline(always)]
    pub const fn pkc_len1(self) -> crate::pac::common::Reg<PkcLen1, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x1cusize) as _) }
    }
    #[doc = "Mode register, parameter set 2."]
    #[inline(always)]
    pub const fn pkc_mode2(self) -> crate::pac::common::Reg<PkcMode2, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x20usize) as _) }
    }
    #[doc = "X+Y pointer register, parameter set 2."]
    #[inline(always)]
    pub const fn pkc_xyptr2(self) -> crate::pac::common::Reg<PkcXyptr2, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x24usize) as _) }
    }
    #[doc = "Z+R pointer register, parameter set 2."]
    #[inline(always)]
    pub const fn pkc_zrptr2(self) -> crate::pac::common::Reg<PkcZrptr2, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x28usize) as _) }
    }
    #[doc = "Length register, parameter set 2."]
    #[inline(always)]
    pub const fn pkc_len2(self) -> crate::pac::common::Reg<PkcLen2, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x2cusize) as _) }
    }
    #[doc = "Universal pointer FUP program."]
    #[inline(always)]
    pub const fn pkc_uptr(self) -> crate::pac::common::Reg<PkcUptr, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x40usize) as _) }
    }
    #[doc = "Universal pointer FUP table."]
    #[inline(always)]
    pub const fn pkc_uptrt(self) -> crate::pac::common::Reg<PkcUptrt, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x44usize) as _) }
    }
    #[doc = "Universal pointer length."]
    #[inline(always)]
    pub const fn pkc_ulen(self) -> crate::pac::common::Reg<PkcUlen, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x48usize) as _) }
    }
    #[doc = "MC pattern data interface."]
    #[inline(always)]
    pub const fn pkc_mcdata(self) -> crate::pac::common::Reg<PkcMcdata, crate::pac::common::RW> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x50usize) as _) }
    }
    #[doc = "PKC version register."]
    #[inline(always)]
    pub const fn pkc_version(self) -> crate::pac::common::Reg<PkcVersion, crate::pac::common::R> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x60usize) as _) }
    }
    #[doc = "Software reset."]
    #[inline(always)]
    pub const fn pkc_soft_rst(self) -> crate::pac::common::Reg<PkcSoftRst, crate::pac::common::W> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0fb0usize) as _) }
    }
    #[doc = "Access Error."]
    #[inline(always)]
    pub const fn pkc_access_err(
        self,
    ) -> crate::pac::common::Reg<PkcAccessErr, crate::pac::common::R> {
    ...
    pub const fn pkc_access_err_clr(
        self,
    ) -> crate::pac::common::Reg<PkcAccessErrClr, crate::pac::common::W> {
    ...
    pub const fn pkc_int_clr_enable(
        self,
    ) -> crate::pac::common::Reg<PkcIntClrEnable, crate::pac::common::W> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0fd8usize) as _) }
    }
    #[doc = "Interrupt enable set."]
    #[inline(always)]
    pub const fn pkc_int_set_enable(
        self,
    ) -> crate::pac::common::Reg<PkcIntSetEnable, crate::pac::common::W> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0fdcusize) as _) }
    }
    #[doc = "Interrupt status."]
    #[inline(always)]
    pub const fn pkc_int_status(
        self,
    ) -> crate::pac::common::Reg<PkcIntStatus, crate::pac::common::R> {
    ...
    pub const fn pkc_int_enable(
        self,
    ) -> crate::pac::common::Reg<PkcIntEnable, crate::pac::common::R> {
    ...
    pub const fn pkc_int_clr_status(
        self,
    ) -> crate::pac::common::Reg<PkcIntClrStatus, crate::pac::common::W> {
    ...
    pub const fn pkc_int_set_status(
        self,
    ) -> crate::pac::common::Reg<PkcIntSetStatus, crate::pac::common::W> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0fecusize) as _) }
    }
    #[doc = "Module ID."]
    #[inline(always)]
    pub const fn pkc_module_id(
        self,
    ) -> crate::pac::common::Reg<PkcModuleId, crate::pac::common::R> {
...
impl PkcVersion {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn mulsize(&self) -> Mulsize {
        let val = (self.0 >> 0usize) & 0x03;
        Mulsize::from_bits(val as u8)
    }
    #[doc = "Native multiplier size and operand granularity."]
    #[inline(always)]
