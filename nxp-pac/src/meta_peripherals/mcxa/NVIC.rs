...
impl Nvic {
    ...
    #[inline(always)]
    pub const fn iser(self, n: usize) -> crate::pac::common::Reg<Iser, crate::pac::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn icer(self, n: usize) -> crate::pac::common::Reg<Icer, crate::pac::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn ispr(self, n: usize) -> crate::pac::common::Reg<Ispr, crate::pac::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn icpr(self, n: usize) -> crate::pac::common::Reg<Icpr, crate::pac::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn iabr(self, n: usize) -> crate::pac::common::Reg<Iabr, crate::pac::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn itns(self, n: usize) -> crate::pac::common::Reg<Itns, crate::pac::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn ipr(self, n: usize) -> crate::pac::common::Reg<Ipr, crate::pac::common::RW> {
        assert!(n < 120usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn stir(self) -> crate::pac::common::Reg<Stir, crate::pac::common::W> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x0e00usize) as _) }
    }
}
#[doc = "Interrupt Active Bit Register."]
#[repr(transparent)]
