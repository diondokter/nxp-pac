...
impl Smartdma0 {
    ...
    #[doc = "Boot Address."]
    #[inline(always)]
    pub const fn bootadr(self) -> crate::common::Reg<Bootadr, crate::common::RW> {
    ...
    #[doc = "Program Counter."]
    #[inline(always)]
    pub const fn pc(self) -> crate::common::Reg<Pc, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x28usize) as _) }
    }
    #[doc = "Stack Pointer."]
    #[inline(always)]
    pub const fn sp(self) -> crate::common::Reg<Sp, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x2cusize) as _) }
    }
    #[doc = "ARM to EZH Interrupt Control."]
    #[inline(always)]
    pub const fn arm2ezh(self) -> crate::common::Reg<Arm2ezh, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x40usize) as _) }
    }
    #[doc = "EZH to ARM Trigger."]
    #[inline(always)]
    pub const fn ezh2arm(self) -> crate::common::Reg<Ezh2arm, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x44usize) as _) }
    }
    #[doc = "Pending Trap Control."]
    #[inline(always)]
    pub const fn pendtrap(self) -> crate::common::Reg<Pendtrap, crate::common::RW> {
