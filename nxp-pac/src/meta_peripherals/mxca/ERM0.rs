...
impl Erm0 {
    ...
    #[inline(always)]
    pub const fn sr0(self) -> crate::common::Reg<Sr0, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x10usize) as _) }
    }
    #[doc = "ERM Memory 0 Error Address Register."]
    #[inline(always)]
    pub const fn ear0(self) -> crate::common::Reg<Ear0, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0100usize) as _) }
    }
    #[doc = "ERM Memory 0 Syndrome Register."]
    #[inline(always)]
    pub const fn syn0(self) -> crate::common::Reg<Syn0, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0104usize) as _) }
    }
    #[doc = "ERM Memory 0 Correctable Error Count Register."]
    #[inline(always)]
    pub const fn corr_err_cnt0(self) -> crate::common::Reg<CorrErrCnt0, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0108usize) as _) }
    }
    #[doc = "ERM Memory 1 Correctable Error Count Register."]
    #[inline(always)]
    pub const fn corr_err_cnt1(self) -> crate::common::Reg<CorrErrCnt1, crate::common::RW> {
