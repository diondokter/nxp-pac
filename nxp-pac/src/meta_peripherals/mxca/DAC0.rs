...
impl Dac0 {
    ...
    #[doc = "Global Control."]
    #[inline(always)]
    pub const fn gcr(self) -> crate::common::Reg<Gcr, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn fpr(self) -> crate::common::Reg<Fpr, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x14usize) as _) }
    }
    #[doc = "FIFO Status."]
    #[inline(always)]
    pub const fn fsr(self) -> crate::common::Reg<Fsr, crate::common::RW> {
    ...
    #[doc = "Reset Control."]
    #[inline(always)]
    pub const fn rcr(self) -> crate::common::Reg<Rcr, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn pcr(self) -> crate::common::Reg<Pcr, crate::common::RW> {
