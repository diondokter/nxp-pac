...
impl Lpspi {
    ...
    #[doc = "DMA Enable."]
    #[inline(always)]
    pub const fn der(self) -> crate::common::Reg<Der, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x1cusize) as _) }
    }
    #[doc = "Configuration 0."]
    #[inline(always)]
    pub const fn cfgr0(self) -> crate::common::Reg<Cfgr0, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x20usize) as _) }
    }
    #[doc = "Configuration 1."]
    #[inline(always)]
    pub const fn cfgr1(self) -> crate::common::Reg<Cfgr1, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x24usize) as _) }
    }
    #[doc = "Data Match 0."]
    #[inline(always)]
    pub const fn dmr0(self) -> crate::common::Reg<Dmr0, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x30usize) as _) }
    }
    #[doc = "Data Match 1."]
    #[inline(always)]
    pub const fn dmr1(self) -> crate::common::Reg<Dmr1, crate::common::RW> {
    ...
    #[doc = "FIFO Control."]
    #[inline(always)]
    pub const fn fcr(self) -> crate::common::Reg<Fcr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x58usize) as _) }
    }
    #[doc = "FIFO Status."]
    #[inline(always)]
    pub const fn fsr(self) -> crate::common::Reg<Fsr, crate::common::R> {
    ...
    #[doc = "Transmit Data."]
    #[inline(always)]
    pub const fn tdr(self) -> crate::common::Reg<Tdr, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x64usize) as _) }
    }
    #[doc = "Receive Status."]
    #[inline(always)]
    pub const fn rsr(self) -> crate::common::Reg<Rsr, crate::common::R> {
    ...
    #[inline(always)]
    pub const fn rdror(self) -> crate::common::Reg<Rdror, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x78usize) as _) }
    }
    #[doc = "Transmit Command Burst."]
    #[inline(always)]
    pub const fn tcbr(self) -> crate::common::Reg<Tcbr, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x03fcusize) as _) }
    }
    #[doc = "Transmit Data Burst."]
    #[inline(always)]
    pub const fn tdbr(self, n: usize) -> crate::common::Reg<Tdbr, crate::common::W> {
        assert!(n < 128usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn rdbr(self, n: usize) -> crate::common::Reg<Rdbr, crate::common::R> {
        assert!(n < 128usize);
        unsafe {
