...
impl Fmu0 {
    ...
    #[inline(always)]
    pub const fn fstat(self) -> crate::common::Reg<Fstat, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "Flash Configuration Register."]
    #[inline(always)]
    pub const fn fcnfg(self) -> crate::common::Reg<Fcnfg, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "Flash Control Register."]
    #[inline(always)]
    pub const fn fctrl(self) -> crate::common::Reg<Fctrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "Flash Common Command Object Registers."]
    #[inline(always)]
    pub const fn fccob(self, n: usize) -> crate::common::Reg<Fccob, crate::common::RW> {
        assert!(n < 8usize);
