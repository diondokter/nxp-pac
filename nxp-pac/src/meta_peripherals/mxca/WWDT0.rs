...
impl Wwdt0 {
    ...
    #[doc = "Mode."]
    #[inline(always)]
    pub const fn mod_(self) -> crate::common::Reg<Mod, crate::common::RW> {
    ...
    #[doc = "Feed Sequence."]
    #[inline(always)]
    pub const fn feed(self) -> crate::common::Reg<Feed, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "Timer Value."]
    #[inline(always)]
    pub const fn tv(self) -> crate::common::Reg<Tv, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0cusize) as _) }
    }
    #[doc = "Warning Interrupt Compare Value."]
    #[inline(always)]
    pub const fn warnint(self) -> crate::common::Reg<Warnint, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x14usize) as _) }
    }
    #[doc = "Window Compare Value."]
    #[inline(always)]
    pub const fn window(self) -> crate::common::Reg<Window, crate::common::RW> {
