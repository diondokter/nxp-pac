...
impl Sgi0 {
    ...
    pub const fn sgi_access_err_clr(
        self,
    ) -> crate::common::Reg<SgiAccessErrClr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0fc4usize) as _) }
    }
    #[doc = "Interrupt status."]
    #[inline(always)]
    pub const fn sgi_int_status(self) -> crate::common::Reg<SgiIntStatus, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0fe0usize) as _) }
    }
    #[doc = "Interrupt enable."]
    #[inline(always)]
    pub const fn sgi_int_enable(self) -> crate::common::Reg<SgiIntEnable, crate::common::RW> {
    ...
    pub const fn sgi_int_status_clr(
        self,
    ) -> crate::common::Reg<SgiIntStatusClr, crate::common::RW> {
    ...
    pub const fn sgi_int_status_set(
        self,
    ) -> crate::common::Reg<SgiIntStatusSet, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0fecusize) as _) }
    }
    #[doc = "Module ID."]
    #[inline(always)]
    pub const fn sgi_module_id(self) -> crate::common::Reg<SgiModuleId, crate::common::R> {
