...
impl Csr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn scs(&self) -> CsrScs {
        let val = (self.0 >> 24usize) & 0x07;
        CsrScs::from_bits(val as u8)
    }
    #[doc = "System Clock Source."]
    #[inline(always)]
    pub const fn set_scs(&mut self, val: CsrScs) {
...
impl Rccr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn scs(&self) -> RccrScs {
        let val = (self.0 >> 24usize) & 0x07;
        RccrScs::from_bits(val as u8)
    }
    #[doc = "System Clock Source."]
    #[inline(always)]
    pub const fn set_scs(&mut self, val: RccrScs) {
        self.0 = (self.0 & !(0x07 << 24usize)) | (((val.to_bits() as u32) & 0x07) << 24usize);
    }
}
