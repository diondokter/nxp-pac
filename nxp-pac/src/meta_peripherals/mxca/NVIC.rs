...
impl Nvic {
    ...
    #[inline(always)]
    pub const fn iser(self, n: usize) -> crate::common::Reg<Iser, crate::common::RW> {
        assert!(n < 16usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize + n * 4usize) as _) }
    }
    #[doc = "Interrupt Clear Enable Register."]
    #[inline(always)]
    pub const fn icer(self, n: usize) -> crate::common::Reg<Icer, crate::common::RW> {
        assert!(n < 16usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x80usize + n * 4usize) as _) }
    }
    #[doc = "Interrupt Set Pending Register."]
    #[inline(always)]
    pub const fn ispr(self, n: usize) -> crate::common::Reg<Ispr, crate::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn icpr(self, n: usize) -> crate::common::Reg<Icpr, crate::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn iabr(self, n: usize) -> crate::common::Reg<Iabr, crate::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn itns(self, n: usize) -> crate::common::Reg<Itns, crate::common::RW> {
        assert!(n < 16usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn ipr(self, n: usize) -> crate::common::Reg<Ipr, crate::common::RW> {
        assert!(n < 120usize);
        unsafe {
    ...
    #[inline(always)]
    pub const fn stir(self) -> crate::common::Reg<Stir, crate::common::W> {
