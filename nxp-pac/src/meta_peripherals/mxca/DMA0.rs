...
impl Dma0 {
    ...
    #[inline(always)]
    pub const fn mp_csr(self) -> crate::common::Reg<MpCsr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "Management Page Error Status."]
    #[inline(always)]
    pub const fn mp_es(self) -> crate::common::Reg<MpEs, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "Management Page Interrupt Request Status."]
    #[inline(always)]
    pub const fn mp_int(self) -> crate::common::Reg<MpInt, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "Management Page Hardware Request Status."]
    #[inline(always)]
    pub const fn mp_hrs(self) -> crate::common::Reg<MpHrs, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0cusize) as _) }
    }
    #[doc = "Channel Arbitration Group."]
    #[inline(always)]
    pub const fn ch_grpri(self, n: usize) -> crate::common::Reg<ChGrpri, crate::common::RW> {
        assert!(n < 8usize);
        unsafe {
