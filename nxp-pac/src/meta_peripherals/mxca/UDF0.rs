...
impl Udf0 {
    ...
    #[inline(always)]
    pub const fn udf_ctrl(self) -> crate::common::Reg<UdfCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "Status register."]
    #[inline(always)]
    pub const fn udf_status(self) -> crate::common::Reg<UdfStatus, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "Data In Register."]
    #[inline(always)]
    pub const fn udf_wr_data(self) -> crate::common::Reg<UdfWrData, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "Data Out Register."]
    #[inline(always)]
    pub const fn udf_rd_data(self) -> crate::common::Reg<UdfRdData, crate::common::R> {
