...
impl Cmc {
    ...
    #[doc = "Clock Control."]
    #[inline(always)]
    pub const fn ckctrl(self) -> crate::common::Reg<Ckctrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x10usize) as _) }
    }
    #[doc = "Clock Status."]
    #[inline(always)]
    pub const fn ckstat(self) -> crate::common::Reg<Ckstat, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x14usize) as _) }
    }
    #[doc = "Power Mode Protection."]
    #[inline(always)]
    pub const fn pmprot(self) -> crate::common::Reg<Pmprot, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x18usize) as _) }
    }
    #[doc = "Global Power Mode Control."]
    #[inline(always)]
    pub const fn gpmctrl(self) -> crate::common::Reg<Gpmctrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x1cusize) as _) }
    }
    #[doc = "Power Mode Control."]
    #[inline(always)]
    pub const fn pmctrlmain(self) -> crate::common::Reg<Pmctrlmain, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x20usize) as _) }
    }
    #[doc = "System Reset Status."]
    #[inline(always)]
    pub const fn srs(self) -> crate::common::Reg<Srs, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x80usize) as _) }
    }
    #[doc = "Reset Pin Control."]
    #[inline(always)]
    pub const fn rpc(self) -> crate::common::Reg<Rpc, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x84usize) as _) }
    }
    #[doc = "Sticky System Reset Status."]
    #[inline(always)]
    pub const fn ssrs(self) -> crate::common::Reg<Ssrs, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x88usize) as _) }
    }
    #[doc = "System Reset Interrupt Enable."]
    #[inline(always)]
    pub const fn srie(self) -> crate::common::Reg<Srie, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x8cusize) as _) }
    }
    #[doc = "System Reset Interrupt Flag."]
    #[inline(always)]
    pub const fn srif(self) -> crate::common::Reg<Srif, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x90usize) as _) }
    }
    #[doc = "Mode."]
    #[inline(always)]
    pub const fn mr0(self) -> crate::common::Reg<Mr0, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0xa0usize) as _) }
    }
    #[doc = "Force Mode."]
    #[inline(always)]
    pub const fn fm0(self) -> crate::common::Reg<Fm0, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0xb0usize) as _) }
    }
    #[doc = "Flash Control."]
    #[inline(always)]
    pub const fn flashcr(self) -> crate::common::Reg<Flashcr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0xe0usize) as _) }
    }
    #[doc = "Core Control."]
    #[inline(always)]
    pub const fn corectl(self) -> crate::common::Reg<Corectl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0110usize) as _) }
    }
    #[doc = "Debug Control."]
    #[inline(always)]
    pub const fn dbgctl(self) -> crate::common::Reg<Dbgctl, crate::common::RW> {
