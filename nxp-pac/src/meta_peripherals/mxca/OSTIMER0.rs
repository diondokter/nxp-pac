...
impl Ostimer0 {
    ...
    #[doc = "EVTIMER Low."]
    #[inline(always)]
    pub const fn evtimerl(self) -> crate::common::Reg<Evtimerl, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "EVTIMER High."]
    #[inline(always)]
    pub const fn evtimerh(self) -> crate::common::Reg<Evtimerh, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "Local Capture Low for CPU."]
    #[inline(always)]
    pub const fn capture_l(self) -> crate::common::Reg<CaptureL, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "Local Capture High for CPU."]
    #[inline(always)]
    pub const fn capture_h(self) -> crate::common::Reg<CaptureH, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0cusize) as _) }
    }
    #[doc = "Local Match Low for CPU."]
    #[inline(always)]
    pub const fn match_l(self) -> crate::common::Reg<MatchL, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x10usize) as _) }
    }
    #[doc = "Local Match High for CPU."]
    #[inline(always)]
    pub const fn match_h(self) -> crate::common::Reg<MatchH, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x14usize) as _) }
    }
    #[doc = "OSTIMER Control for CPU."]
    #[inline(always)]
    pub const fn osevent_ctrl(self) -> crate::common::Reg<OseventCtrl, crate::common::RW> {
