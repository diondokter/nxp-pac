...
impl SysTick {
    ...
    #[inline(always)]
    pub const fn syst_csr(self) -> crate::common::Reg<SystCsr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "SysTick Reload Value Register."]
    #[inline(always)]
    pub const fn syst_rvr(self) -> crate::common::Reg<SystRvr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "SysTick Current Value Register."]
    #[inline(always)]
    pub const fn syst_cvr(self) -> crate::common::Reg<SystCvr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "SysTick Calibration Value Register."]
    #[inline(always)]
    pub const fn syst_calib(self) -> crate::common::Reg<SystCalib, crate::common::R> {
