...
impl Lptmr0 {
    ...
    #[inline(always)]
    pub const fn psr(self) -> crate::common::Reg<Psr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "Compare."]
    #[inline(always)]
    pub const fn cmr(self) -> crate::common::Reg<Cmr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "Counter."]
    #[inline(always)]
    pub const fn cnr(self) -> crate::common::Reg<Cnr, crate::common::RW> {
