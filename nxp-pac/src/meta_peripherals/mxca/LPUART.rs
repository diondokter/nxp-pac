...
impl Lpuart {
    ...
    #[doc = "Global."]
    #[inline(always)]
    pub const fn global(self) -> crate::common::Reg<Global, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "Pin Configuration."]
    #[inline(always)]
    pub const fn pincfg(self) -> crate::common::Reg<Pincfg, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0cusize) as _) }
    }
    #[doc = "Baud Rate."]
    #[inline(always)]
    pub const fn baud(self) -> crate::common::Reg<Baud, crate::common::RW> {
    ...
    #[doc = "Match Address."]
    #[inline(always)]
    pub const fn match_(self) -> crate::common::Reg<Match, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x20usize) as _) }
    }
    #[doc = "MODEM IrDA."]
    #[inline(always)]
    pub const fn modir(self) -> crate::common::Reg<Modir, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x24usize) as _) }
    }
    #[doc = "FIFO."]
    #[inline(always)]
    pub const fn fifo(self) -> crate::common::Reg<Fifo, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x28usize) as _) }
    }
    #[doc = "Watermark."]
    #[inline(always)]
    pub const fn water(self) -> crate::common::Reg<Water, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x2cusize) as _) }
    }
    #[doc = "Data Read-Only."]
    #[inline(always)]
    pub const fn dataro(self) -> crate::common::Reg<Dataro, crate::common::R> {
